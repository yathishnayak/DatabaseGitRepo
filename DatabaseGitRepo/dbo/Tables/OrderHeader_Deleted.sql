CREATE TABLE [dbo].[OrderHeader_Deleted] (
...
GO
CREATE NONCLUSTERED INDEX [IX_OrderHeader_Deleted_missing_20220903_1]
    ON [dbo].[OrderHeader_Deleted]([CustKey] ASC) WITH (FILLFACTOR = 90);
