CREATE TABLE [dbo].[SELL_NAC_Accessorial_FileProcessInfo] (
    ...
    [UserKey]           INT           NULL,
    CONSTRAINT [PK_Sell_NAC_Accessorial_FileProcessInfo] PRIMARY KEY CLUSTERED ([FileProcessKey] ASC) WITH (FILLFACTOR = 90)
);
