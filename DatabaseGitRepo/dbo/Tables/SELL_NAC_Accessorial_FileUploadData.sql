CREATE TABLE [dbo].[SELL_NAC_Accessorial_FileUploadData] (
    ...
    [IsArchived]        BIT             NULL,
    CONSTRAINT [PK_SELL_NAC_Accessorial_FileUploadData] PRIMARY KEY CLUSTERED ([FileProcessKey] ASC, [RecordSL] ASC)
);
