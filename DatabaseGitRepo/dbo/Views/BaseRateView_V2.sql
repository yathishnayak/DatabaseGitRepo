...
CREATE view  [dbo].[BaseRateView_V2]
as
select BR.BaseRateKey, BR.ClientOrBrokerKey, BR.IsClient, BR.IsBroker, BR.CityKey,  R.BrokerName  as BrokerOrClientName,
--case when BR.IsClient = 1 then C.ClientName else R.BrokerName end as BrokerOrClientName,
