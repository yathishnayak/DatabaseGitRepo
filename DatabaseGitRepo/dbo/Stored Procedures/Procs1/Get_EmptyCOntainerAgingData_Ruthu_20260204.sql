...
Declare 
	...
	@IsDebug		BIT = 0
	@JSONSTRING NVARCHAR = '{}'
		EXEC [Get_EmptyCOntainerAgingData_Ruthu_20260204] @Userkey, @JSONSTRING, @Status OUTPUT, @Reason Output, @IsDebug
**/

CREATE PROCEDURE [dbo].[Get_EmptyCOntainerAgingData_Ruthu_20260204] --  exec [Get_EmptyCOntainerAgingData_Ruthu_20260204]
(
	@UserKey		INT = 714,
	@JSONString		NVARCHAR(MAX) = '',
	@Status			BIT	= 0 OUTPUT,
