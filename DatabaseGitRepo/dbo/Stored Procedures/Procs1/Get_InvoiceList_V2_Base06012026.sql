...
DECLARE 
	@UserKey INT=714,
	--@JSONString NVARCHAR(MAX)='{"Factored":2,"CustApproved":2,"PageNo":1,"PageSize":50,"Ascending":true,"IsAscending":true,"SearchText":"129128","CustomerKey":"","MarketLocationKey":"","InvoicerKey":"","CustCompanyKey":"","SortField":"TerminationDate","StatusKey":3}',
	--@JSONString NVARCHAR(MAX)='{"Factored":2,"CustApproved":2,"PageNo":1,"PageSize":50,"Ascending":true,"IsAscending":true,"SearchText":"SAGE240302","CustomerKey":"","MarketLocationKey":"","InvoicerKey":"","CustCompanyKey":"","ChargeConfirmed":2,"SortField":"TerminationDate","StatusKey":16,"WarehouseStatusKeys":""}',
	@JSONString NVARCHAR(MAX)='{"Factored":2,"CustApproved":2,"PageNo":1,"PageSize":50,"Ascending":true,"IsAscending":true,"CustomerKey":"","MarketLocationKey":"","InvoicerKey":"","CustCompanyKey":"","ChargeConfirmed":2,"SortField":"TerminationDate","StatusKey":9,"WarehouseStatusKeys":"","DoorToDoor":"1"}'
	,@Status BIT=0,@IsDebug		BIT = 0,
	@Reason VARCHAR(100)=''
EXec Get_InvoiceList_V2_Base06012026 @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT,@IsDebug
Select @Status, @Reason
**/

CREATE Procedure [dbo].[Get_InvoiceList_V2_Base06012026] -- Get_InvoiceList_V2 @StatusKey=2, @PageNo = 1,@SearchText='WHSU5296890'
(
	@UserKey		INT = 714,
