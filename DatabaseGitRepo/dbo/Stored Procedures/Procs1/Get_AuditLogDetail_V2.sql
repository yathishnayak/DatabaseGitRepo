...
-- [Get_AuditLogDetail] 'Container', 13282
...
Declare 
	...
	@Reason			VARCHAR(1000) = '',
	@IsDebug		BIT = 0,
	@JSONSTRING		NVARCHAR(Max) = '{"RefType" : "Container", "RefKey":47698}'
	EXEC [Get_AuditLogDetail_V2] @Userkey, @JSONSTRING, @Status OUTPUT, @Reason Output, @IsDebug
	SELECT @Status Status, @Reason Reason
**/
CREATE Procedure [dbo].[Get_AuditLogDetail_V2] 
(
	@UserKey		INT = 1144,
...
Begin
	...
	select AuditKey, 
		...
		Comments 
	into #auditlog
	from [AuditLogDetail] with (nolock)
