...
CREATE PROC [dbo].[Get_ContainerLegDetails] -- Get_ContainerLegDetails 243272  
(  
...
BEGIN  
 ...
 SELECT OD.ContainerNo,  
  ...
  ISNULL(RT.DeliveryDateFrom,RT.DeliveryDateTo) AS ScheduledDeliveryDate,RT.DeliveryDateTo AS ScheduledDeliveryDateTo, ISNULL(CH.chassisNo, RT.ChassisNO) as ChassisID,  
...
--   then 1 else 0 end as ReadyToMarkComplete,  
  ...
  RT.NoEmptyAvailableMarked,RT.NoEmptyAvailableMarkedBY,RT.NoEmptyAvailableMarkedDate,  
