...
DECLARE 
				  ...
				  "ConfirmDate": [
					{
					  ...
					  "Prepulllocation1": "Loc1",
					  "Prepullcost1": "97.55",

					  "TruckTypeA": "A",
					  "TruckTypeABaseCost1": "7",
					  "TruckTypeAFSF1": "8",
					  "TruckTypeAFROM1": "Yard1,Yard2",

					  "EffectiveDate": "2023-11-20",
					  "EffectiveDateFrom": "2023-11-01"
					}
				  ]
				}',
	@Status	BIT = 0, 
	...
	Select @Status AS Status, @Reason AS Reason
*/
CREATE PROCEDURE [dbo].[COST_InsertFileProcessData_Chicago_V2] -- COST_InsertFileProcessData_Chicago 3,'[{"Market":"Market","Terminal":"Terminal","City":"City","State":"State","ZipCode":"ZipCode","Zone":"Zone","Prepulllocation1":"Prepulllocation1","Prepullcost1":"97.5453016591252","Prepulllocation2":"Prepulllocation2","Prepullcost2":"2","Stopofflocation1":"Stopofflocation1","Stopoffcost1":"3","Stopofflocation2":"Stopofflocation2","Stopoffcost2":"4","YardshuttledirectionTO1":"YardshuttledirectionTO1","YardshuttledirectionFROM1":"YardshuttledirectionFROM1","Yardshuttlecost1":"5","YardshuttledirectionTO2":"YardshuttledirectionTO2","YardshuttledirectionFROM2":"YardshuttledirectionFROM2","Yardshuttlecost2":"6","TruckType1":"TruckType1","TruckType1BaseCost":"7","TruckType1FSF":"8","TruckType2":"TruckType2","TruckType2BaseCost":"9","TruckType2FSC":"10","TruckType3":"TruckType3","TruckType3BaseCost":"11","TruckType3FSC":"12","EffectiveDate":"20-11-2023","EffectiveDateFrom":"EffectiveDateFrom"}]'
(
	@UserKey		INT = 1144,
	@JSONString		NVARCHAR(MAX) = '',
	@Status			BIT	= 0 OUTPUT,
...
BEGIN
	...
	SET		@Status = 1 
	SET		@Reason = 'Record Uploaded Successfully'
...
(	SlNo						INT,
	...
	INSERT INTO				#FileUploadData
							(SlNo, Market,Terminal,City,State,ZipCode,Zone,Prepulllocation1,Prepullcost1,Prepulllocation2,Prepullcost2,Stopofflocation1,Stopoffcost1,Stopofflocation2,Stopoffcost2
							,YardshuttledirectionTO1,YardshuttledirectionFROM1,Yardshuttlecost1,YardshuttledirectionTO2,YardshuttledirectionFROM2,Yardshuttlecost2
	...
	SELECT					ROW_NUMBER() OVER(ORDER BY City),Market,Terminal,City,State,ZipCode,Zone,Prepulllocation1
							...
							,CASE WHEN ISNULL(Prepulllocation2,'') = '' AND  Prepullcost2 = '0.0' THEN '' ELSE Prepullcost2 END,Stopofflocation1--,Prepulllocation3
							...
							--,CASE WHEN ISNULL(Prepulllocation5,'') = '' AND  Prepullcost5 = '0.0' THEN '' ELSE Prepullcost5 END--
							...
							--,CASE WHEN ISNULL(Stopofflocation5,'') = '' AND  Stopoffcost5 = '0.0' THEN '' ELSE Stopoffcost5 END
							,REPLACE(YardshuttledirectionTO1,'To','')	
							,REPLACE(YardshuttledirectionFROM1,'From','')
							,CASE WHEN ISNULL(YardshuttledirectionTO1,'') = '' AND ISNULL(YardshuttledirectionFROM1,'') = '' AND Yardshuttlecost1 = '0.0' THEN '' ELSE Yardshuttlecost1 END
							,REPLACE(YardshuttledirectionTO2,'To','')
							,REPLACE(YardshuttledirectionFROM2,'From','')
							...
							,TruckTypeAFROM2
							,CASE WHEN TruckTypeABaseCost3 = '0.0' THEN '' ELSE TruckTypeABaseCost3 END
							,CASE WHEN TruckTypeAFSF3 = '0.0' THEN '' ELSE TruckTypeAFSF3 END
							,TruckTypeAFROM3
							,TruckTypeB
							...
							,TruckTypeBFROM2
							,CASE WHEN TruckTypeBBaseCost3 = '0.0' THEN '' ELSE TruckTypeBBaseCost3 END
							,CASE WHEN TruckTypeBFSC3 = '0.0' THEN '' ELSE TruckTypeBFSC3 END
							,TruckTypeBFROM3
							,TruckTypeC
							...
							,TruckTypeCFROM2
							,CASE WHEN TruckTypeCBaseCost3 = '0.0' THEN '' ELSE TruckTypeCBaseCost3 END
							,CASE WHEN TruckTypeCFSC3 = '0.0' THEN '' ELSE TruckTypeCFSC3 END
							,TruckTypeCFROM3
							,TruckTypeD
							,CASE WHEN TruckTypeDBaseCost1 = '0.0' THEN '' ELSE TruckTypeDBaseCost1 END
							,CASE WHEN TruckTypeDFSC1 = '0.0' THEN '' ELSE TruckTypeDFSC1 END
							,TruckTypeDFROM1 
							,CASE WHEN TruckTypeDBaseCost2 = '0.0' THEN '' ELSE TruckTypeDBaseCost2 END
							,CASE WHEN TruckTypeDFSC2 = '0.0' THEN '' ELSE TruckTypeDFSC2 END
							,TruckTypeDFROM2
							,CASE WHEN TruckTypeDBaseCost3 = '0.0' THEN '' ELSE TruckTypeDBaseCost3 END
							,CASE WHEN TruckTypeDFSC3 = '0.0' THEN '' ELSE TruckTypeDFSC3 END
							,TruckTypeDFROM3
							,EffectiveDate,EffectiveDateFrom
...
--- Date Validation Logic End
	...
	DECLARE		@Market VARCHAR(100) ,@Terminal VARCHAR(100) ,@City VARCHAR(100) ,@State VARCHAR(100) ,@ZipCode VARCHAR(20) ,@Zone VARCHAR(10) 
				,@Prepulllocation1 VARCHAR(100), @Prepullcost1 VARCHAR(100), @Prepulllocation2 VARCHAR(100) ,@Prepullcost2 VARCHAR(100) 
				--,@Prepulllocation3 VARCHAR(100) ,@Prepullcost3 VARCHAR(100) ,@Prepulllocation4 VARCHAR(100)	,@Prepullcost4 VARCHAR(100) ,@Prepulllocation5 VARCHAR(100) ,@Prepullcost5 VARCHAR(100) 
				,@Stopofflocation1 VARCHAR(100) ,@Stopoffcost1 VARCHAR(100) ,@Stopofflocation2 VARCHAR(100) ,@Stopoffcost2 VARCHAR(100) 
				--,@Stopofflocation3 VARCHAR(100) ,@Stopoffcost3 VARCHAR(100) ,@Stopofflocation4 VARCHAR(100) ,@Stopoffcost4 VARCHAR(100) ,@Stopofflocation5 VARCHAR(100) ,@Stopoffcost5 VARCHAR(100) 
				,@YardshuttledirectionTO1		VARCHAR(100), @YardshuttledirectionFROM1	VARCHAR(100) ,@Yardshuttlecost1 VARCHAR(100) 
				,@YardshuttledirectionTO2		VARCHAR(100) ,@YardshuttledirectionFROM2	VARCHAR(100) ,@Yardshuttlecost2 VARCHAR(100) 
				...
				,@TruckTypeABaseCost3 		VARCHAR(100),@TruckTypeAFSF3 		VARCHAR(100),@TruckTypeAFROM3 	VARCHAR(100)
				...
				,@TruckTypeBBaseCost3 		VARCHAR(100),@TruckTypeBFSC3 		VARCHAR(100),@TruckTypeBFROM3 	VARCHAR(100)
				...
				,@TruckTypeCBaseCost3 		VARCHAR(100),@TruckTypeCFSC3 		VARCHAR(100),@TruckTypeCFROM3 	VARCHAR(100)
				,@TruckTypeD 				VARCHAR(100),@TruckTypeDBaseCost1 	VARCHAR(100),@TruckTypeDFSC1 	VARCHAR(100),@TruckTypeDFROM1 	VARCHAR(100)
				,@TruckTypeDBaseCost2 		VARCHAR(100),@TruckTypeDFSC2 		VARCHAR(100),@TruckTypeDFROM2 	VARCHAR(100)
				,@TruckTypeDBaseCost3 		VARCHAR(100),@TruckTypeDFSC3 		VARCHAR(100),@TruckTypeDFROM3 	VARCHAR(100)
				--,@TruckTypeE 				VARCHAR(100),@TruckTypeEBaseCost1 	VARCHAR(100),@TruckTypeEFSC1  	VARCHAR(100) 
				,@EffectiveDate VARCHAR(100) ,@EffectiveDateFrom VARCHAR(100)
	...
	WHILE(@i < = @n)
		BEGIN
			SELECT	 @Market = Market,@Terminal = Terminal,@City = City , @State = State, @ZipCode = ZipCode,@Zone = Zone
					...
					,@TruckTypeABaseCost3 = TruckTypeABaseCost3,@TruckTypeAFSF3 = TruckTypeAFSF3,@TruckTypeAFROM3 = TruckTypeAFROM3
					...
					,@TruckTypeBBaseCost3 = TruckTypeBBaseCost3,@TruckTypeBFSC3 = TruckTypeBFSC3,@TruckTypeBFROM3 = TruckTypeBFROM3
					...
					,@TruckTypeCBaseCost3 = TruckTypeCBaseCost3,@TruckTypeCFSC3 = TruckTypeCFSC3,@TruckTypeCFROM3 = TruckTypeCFROM3
					,@TruckTypeD = TruckTypeD,@TruckTypeDBaseCost1 = TruckTypeDBaseCost1,@TruckTypeDFSC1 = TruckTypeDFSC1,@TruckTypeDFROM1 = TruckTypeDFROM1
					,@TruckTypeDBaseCost2 = TruckTypeDBaseCost2,@TruckTypeDFSC2 = TruckTypeDFSC2,@TruckTypeDFROM2 = TruckTypeDFROM2
					,@TruckTypeDBaseCost3 = TruckTypeDBaseCost3,@TruckTypeDFSC3 = TruckTypeDFSC3,@TruckTypeDFROM3 = TruckTypeDFROM3
			...
			IF (
			    (ISNULL(@TruckTypeA, '') = ISNULL(@TruckTypeB, '') AND ISNULL(@TruckTypeA, '') <> '' AND ISNULL(@TruckTypeB, '') <> '') OR
			    (ISNULL(@TruckTypeA, '') = ISNULL(@TruckTypeC, '') AND ISNULL(@TruckTypeA, '') <> '' AND ISNULL(@TruckTypeC, '') <> '') OR
			    (ISNULL(@TruckTypeA, '') = ISNULL(@TruckTypeD, '') AND ISNULL(@TruckTypeA, '') <> '' AND ISNULL(@TruckTypeD, '') <> '') OR
			    (ISNULL(@TruckTypeB, '') = ISNULL(@TruckTypeC, '') AND ISNULL(@TruckTypeB, '') <> '' AND ISNULL(@TruckTypeC, '') <> '') OR
			    (ISNULL(@TruckTypeB, '') = ISNULL(@TruckTypeD, '') AND ISNULL(@TruckTypeB, '') <> '' AND ISNULL(@TruckTypeD, '') <> '') OR
			    (ISNULL(@TruckTypeC, '') = ISNULL(@TruckTypeD, '') AND ISNULL(@TruckTypeC, '') <> '' AND ISNULL(@TruckTypeD, '') <> '')
			)
			BEGIN
			    SET @Status = 0
			    SET @RecordStatus = 0
			    SET @RecordRemarks = ISNULL(@RecordRemarks, '') + 'Truck types A, B, C, and D cannot have the same non-empty value;';
			END

-------------------------------------------- Truck Type A -------------------------------------------------

			IF(ISNULL(@TruckTypeA, '') = '' AND ISNULL(@TruckTypeB, '') = '' AND ISNULL(@TruckTypeC, '') = '' AND ISNULL(@TruckTypeD, '') = '')
			BEGIN
			    SET @Status = 0
			    SET @RecordStatus = 0
			    SET @RecordRemarks = ISNULL(@RecordRemarks, '') + 'At least one Truck Type (A, B, C, or D) must have a value;'
			END
			...
			ELSE IF((ISNULL(@TruckTypeABaseCost2,'') <> ''  OR @TruckTypeABaseCost2 <> '0.0' ) AND ISNULL(@TruckTypeAFROM2,'') <> '' AND ISNULL(@TruckTypeA,'') = '' )
				BEGIN
					...
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type A cannot be Blank;'
				END
			ELSE IF ((SELECT COUNT(*) FROM TruckType WHERE TruckType = @TruckTypeA ) = 0 and isnull(@TruckTypeA, '') <> '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
			...
			IF(ISNULL(@TruckTypeABaseCost1 ,'') = '' and isnull(@TruckTypeA, '') <> '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type A Base Cost 1 Cannot be blank;'
				END
			ELSE IF(ISNULL(@TruckTypeABaseCost1 ,'') <> '' and ISNUMERIC(REPLACE(@TruckTypeABaseCost1,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
			...
			IF(ISNULL(@TruckTypeAFROM1,'') = '' and isnull(@TruckTypeA, '') <> '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
			...
			IF(ISNULL(@TruckTypeAFROM2,'') <> '')
				BEGIN					
					...
					IF(@TempRemarks <> '')
						...
						END
				END
			IF(ISNULL(@TruckTypeABaseCost3,'') <> '' AND ISNULL(@TruckTypeAFROM3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type A From 3 cannot be Blank;'
				END
			ELSE IF(ISNULL(@TruckTypeAFROM3,'') <> '' AND ISNULL(@TruckTypeABaseCost3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type A Base Cost 3 cannot be Blank;'
				END					


			IF( ISNULL(@TruckTypeABaseCost3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeABaseCost3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type A Base Cost 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeABaseCost3) = 1)
				BEGIN
					SET @TruckTypeABaseCost3 = CAST(REPLACE(@TruckTypeABaseCost3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeAFSF3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeAFSF3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type A FSF 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeAFSF3) = 1)
				BEGIN
					SET @TruckTypeAFSF3 = CAST(REPLACE(@TruckTypeAFSF3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeAFROM3,'') <> '')
				BEGIN					
					DELETE FROM #TEMPPROCESS
					SET @TempRemarks = ''
					...
					INSERT INTO #TEMPPROCESS
					SELECT RTRIM(LTRIM(value))
					FROM STRING_SPLIT(@TruckTypeAFROM3, ',')

					SET @TempRemarks = (SELECT DISTINCT 'Verify Truck Type A From 3 Details;' FROM #TEMPPROCESS TP
					LEFT OUTER JOIN #Yard Y ON ( TP.Textvalue = Y.YardType )
					WHERE YardType is NULL)
...
-----------------------------
			...
			IF(ISNULL(@TruckTypeBBaseCost3,'') <> '' AND ISNULL(@TruckTypeBFROM3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type B From 3 cannot be Blank;'
				END
			ELSE IF(ISNULL(@TruckTypeBFROM3,'') <> '' AND ISNULL(@TruckTypeBBaseCost3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type B Base Cost 3 cannot be Blank;'
				END					


			IF( ISNULL(@TruckTypeBBaseCost3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeBBaseCost3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type B Base Cost 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeBBaseCost3) = 1)
				BEGIN
					SET @TruckTypeBBaseCost3 = CAST(REPLACE(@TruckTypeBBaseCost3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeBFSC3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeBFSC3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type B FSF 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeBFSC3) = 1)
				BEGIN
					SET @TruckTypeBFSC3 = CAST(REPLACE(@TruckTypeBFSC3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeBFROM3,'') <> '')
				BEGIN					
					DELETE FROM #TEMPPROCESS
					SET @TempRemarks = ''
					...
					INSERT INTO #TEMPPROCESS
					SELECT RTRIM(LTRIM(value))
					FROM STRING_SPLIT(@TruckTypeBFROM3, ',')

					SET @TempRemarks = (SELECT DISTINCT 'Verify Truck Type B From 3 Details;' FROM #TEMPPROCESS TP
					LEFT OUTER JOIN #Yard Y ON ( TP.Textvalue = Y.YardType )
					WHERE YardType is NULL)
...
-----------------
			...
			IF(ISNULL(@TruckTypeCFROM2,'') <> '')
				...
				END
-----------------
			IF(ISNULL(@TruckTypeCBaseCost3,'') <> '' AND ISNULL(@TruckTypeCFROM3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type C From 3 cannot be Blank;'
				END
			ELSE IF(ISNULL(@TruckTypeCFROM3,'') <> '' AND ISNULL(@TruckTypeCBaseCost3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type C Base Cost 3 cannot be Blank;'
				END					


			IF( ISNULL(@TruckTypeCBaseCost3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeCBaseCost3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type C Base Cost 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeCBaseCost3) = 1)
				BEGIN
					SET @TruckTypeCBaseCost3 = CAST(REPLACE(@TruckTypeCBaseCost3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeCFSC3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeCFSC3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type C FSF 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeCFSC3) = 1)
				BEGIN
					SET @TruckTypeCFSC3 = CAST(REPLACE(@TruckTypeCFSC3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeCFROM3,'') <> '')
				BEGIN					
					DELETE FROM #TEMPPROCESS
					SET @TempRemarks = ''
					...
					INSERT INTO #TEMPPROCESS
					SELECT RTRIM(LTRIM(value))
					FROM STRING_SPLIT(@TruckTypeCFROM3, ',')

					SET @TempRemarks = (SELECT DISTINCT 'Verify Truck Type C From 3 Details;' FROM #TEMPPROCESS TP
					LEFT OUTER JOIN #Yard Y ON ( TP.Textvalue = Y.YardType )
					WHERE YardType is NULL)
			...
			IF((ISNULL(@TruckTypeDBaseCost1,'') <> ''  OR @TruckTypeDBaseCost1 <> '0.0' ) AND ISNULL(@TruckTypeDFROM1,'') <> ''   AND ISNULL(@TruckTypeD,'') = '' )
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D cannot be Blank;'
				END
			IF((ISNULL(@TruckTypeDBaseCost2,'') <> ''  OR @TruckTypeDBaseCost2 <> '0.0' ) AND ISNULL(@TruckTypeDFROM2,'') <> ''   AND ISNULL(@TruckTypeD,'') = '' )
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D cannot be Blank;'
			...
			IF(ISNULL(@TruckTypeDFROM1,'') = ISNULL(@TruckTypeDFROM2,'') AND ISNULL(@TruckTypeDFROM1,'') <> '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D From 1 and Truck Type D From 2 cannot be same;'
				END

			IF(ISNULL(@TruckTypeDBaseCost1,'') <> '' AND ISNULL(@TruckTypeDFROM1,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D From 1 cannot be Blank;'
				END
			ELSE IF(ISNULL(@TruckTypeDFROM1,'') <> '' AND ISNULL(@TruckTypeDBaseCost1,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D Base Cost 1 cannot be Blank;'
				END					

			IF( ISNULL(@TruckTypeDBaseCost1,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeDBaseCost1,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D Base Cost 1 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeDBaseCost1) = 1)
				BEGIN
					SET @TruckTypeDBaseCost1 = CAST(REPLACE(@TruckTypeDBaseCost1,'$','') AS DECIMAL(18,2))
				END

			IF(ISNULL(@TruckTypeDFSC1,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeDFSC1,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D FSF 1 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeDFSC1) = 1)
				BEGIN
					SET @TruckTypeDFSC1 = CAST(REPLACE(@TruckTypeDFSC1,'$','') AS DECIMAL(18,2))
				END

			IF(ISNULL(@TruckTypeDFROM1,'') <> '')
				BEGIN					
					DELETE FROM #TEMPPROCESS
					SET @TempRemarks = ''
					...
					INSERT INTO #TEMPPROCESS
					SELECT RTRIM(LTRIM(value))
					FROM STRING_SPLIT(@TruckTypeDFROM1, ',')

					SET @TempRemarks = (SELECT DISTINCT 'Verify Truck Type D From 2 Details;' FROM #TEMPPROCESS TP
					LEFT OUTER JOIN #Yard Y ON ( TP.Textvalue = Y.YardType )
					WHERE YardType is NULL)
				...
				END
-----------------
			IF(ISNULL(@TruckTypeDBaseCost2,'') <> '' AND ISNULL(@TruckTypeDFROM2,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D From 2 cannot be Blank;'
				END
			ELSE IF(ISNULL(@TruckTypeDFROM2,'') <> '' AND ISNULL(@TruckTypeDBaseCost2,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D Base Cost 2 cannot be Blank;'
				END					

			IF( ISNULL(@TruckTypeDBaseCost2,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeDBaseCost2,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D Base Cost 2 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeDBaseCost2) = 1)
				BEGIN
					SET @TruckTypeDBaseCost2 = CAST(REPLACE(@TruckTypeDBaseCost2,'$','') AS DECIMAL(18,2))
				END

			IF(ISNULL(@TruckTypeDFSC2,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeDFSC2,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D FSF 2 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeDFSC2) = 1)
				BEGIN
					SET @TruckTypeDFSC2 = CAST(REPLACE(@TruckTypeDFSC2,'$','') AS DECIMAL(18,2))
				END

			IF(ISNULL(@TruckTypeDFROM2,'') <> '')
				BEGIN					
					DELETE FROM #TEMPPROCESS
					SET @TempRemarks = ''
					...
					INSERT INTO #TEMPPROCESS
					SELECT RTRIM(LTRIM(value))
					FROM STRING_SPLIT(@TruckTypeDFROM2, ',')
				...
				END
-----------------
			IF(ISNULL(@TruckTypeDBaseCost3,'') <> '' AND ISNULL(@TruckTypeDFROM3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D From 3 cannot be Blank;'
				END
			ELSE IF(ISNULL(@TruckTypeDFROM3,'') <> '' AND ISNULL(@TruckTypeDBaseCost3,'') = '')
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D Base Cost 3 cannot be Blank;'
				END					


			IF( ISNULL(@TruckTypeDBaseCost3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeDBaseCost3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D Base Cost 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeDBaseCost3) = 1)
				BEGIN
					SET @TruckTypeDBaseCost3 = CAST(REPLACE(@TruckTypeDBaseCost3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeDFSC3,'') <> '' AND ISNUMERIC(REPLACE(@TruckTypeDFSC3,'$','')) = 0)
				BEGIN
					SET @Status = 0
					SET	@RecordStatus = 0
					SET	@RecordRemarks = @RecordRemarks + 'Truck Type D FSF 3 Should be a Number;'
				END
			ELSE IF (ISNUMERIC(@TruckTypeDFSC3) = 1)
				BEGIN
					SET @TruckTypeDFSC3 = CAST(REPLACE(@TruckTypeDFSC3,'$','') AS DECIMAL(18,3))
				END


			IF(ISNULL(@TruckTypeDFROM3,'') <> '')
				BEGIN					
					DELETE FROM #TEMPPROCESS
					SET @TempRemarks = ''
					...
					INSERT INTO #TEMPPROCESS
					SELECT RTRIM(LTRIM(value))
					FROM STRING_SPLIT(@TruckTypeDFROM3, ',')

					SET @TempRemarks = (SELECT DISTINCT 'Verify Truck Type D From 3 Details;' FROM #TEMPPROCESS TP
					LEFT OUTER JOIN #Yard Y ON ( TP.Textvalue = Y.YardType )
					WHERE YardType is NULL)
...
Print 2
	...
	Print 3
		INSERT INTO				COST_FileUploadData_Chicago
								(FileProcesskey,RecordSL,Market,Terminal,City,State,ZipCode,Zone,Prepulllocation1,Prepullcost1,Prepulllocation2,Prepullcost2
								,Stopofflocation1,Stopoffcost1,Stopofflocation2,Stopoffcost2
								,YardshuttledirectionTO1,YardshuttledirectionFROM1,Yardshuttlecost1,YardshuttledirectionTO2,YardshuttledirectionFROM2,Yardshuttlecost2
								,TruckTypeA,TruckTypeABaseCost1,TruckTypeAFSF1,TruckTypeAFROM1,TruckTypeABaseCost2,TruckTypeAFSF2,TruckTypeAFROM2
								,TruckTypeABaseCost3,TruckTypeAFSF3,TruckTypeAFROM3
								,TruckTypeB,TruckTypeBBaseCost1,TruckTypeBFSC1,TruckTypeBFROM1,TruckTypeBBaseCost2,TruckTypeBFSC2,TruckTypeBFROM2
		...
		SELECT					@FileProcesskey,SlNo,Market,Terminal,City,State,ZipCode,Zone,Prepulllocation1,Prepullcost1,Prepulllocation2,Prepullcost2
								,Stopofflocation1,Stopoffcost1,Stopofflocation2,Stopoffcost2
								,YardshuttledirectionTO1,YardshuttledirectionFROM1,Yardshuttlecost1,YardshuttledirectionTO2,YardshuttledirectionFROM2,Yardshuttlecost2
								,TruckTypeA,TruckTypeABaseCost1,TruckTypeAFSF1,TruckTypeAFROM1,TruckTypeABaseCost2,TruckTypeAFSF2,TruckTypeAFROM2
								,TruckTypeABaseCost3,TruckTypeAFSF3,TruckTypeAFROM3
	...
	UPDATE					FP
	SET						FileUploadStatus = 1, FileProcessStatus = @Status, IsFileDownloaded = 0
