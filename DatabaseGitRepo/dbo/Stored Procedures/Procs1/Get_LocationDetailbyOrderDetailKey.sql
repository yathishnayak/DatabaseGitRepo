CREATE PROCEDURE [dbo].[Get_LocationDetailbyOrderDetailKey] -- [Get_LocationDetailbyOrderDetailKey] 'From', 180, 28
@LoationType	VARCHAR(20) ='FROM',
@OrderDetailKey	INT = 170 ,
@LegKey			SMALLINT= 13
AS
BEGIN
	SET NOCOUNT ON;
	...
	SELECT @CustKey = H.CustKey 
	FROM OrderDetail A 
		INNER JOIN OrderHeader H ON A.OrderKey = H.OrderKey
