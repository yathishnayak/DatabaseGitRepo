...
--exec [dbo].[Get_DriverManifestList] @StatusKey=2,@DriverKey=662,@OrderKey=0,@OrderDateFrom=null,@OrderDateTO=null,@DeliVeryDateFom=null,@DelivaryDateTo=null,@OrderNo='',@containerNo='',@voucherNo='',@VoucherKey=0,@DriverHubKey=0

CREATE PROCEDURE [dbo].[Get_DriverManifestList] -- 
@StatusKey           INT= 0,
@DriverKey           INT= 0,
@OrderKey            INT= 0,
...
BEGIN
       ...
       SELECT distinct d.DriverID,d.FirstName,d.LastName,VH.VoucherNo,VH.VoucherDate,
                      ...
                      , A.Week_Start_Date, A.Week_End_Date, d.DriverHubKey, dh.DriverHubName
                             into #tmpManifst
       FROM 
	   ...
	   from (
			   ...
			   union all 
					  ...
					  Week_End_Date, M.DriverHubKey,M.DriverHubName        
					  from   
					  VoucherHeader VH WITH (NOLOCK) 
