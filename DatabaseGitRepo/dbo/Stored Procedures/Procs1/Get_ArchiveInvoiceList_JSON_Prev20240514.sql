...
CREATE Procedure [dbo].[Get_ArchiveInvoiceList_JSON_Prev20240514] -- [Get_ArchiveInvoiceList_JSON] @StatusKey=15, @PageNo = 1
(
	@StatusKey		INT= 0,
	@CustomerKey	INT= 0,
	@OrderKey		INT= 0,
...
BEGIN
	...
	SELECT @ArchiveCount= COUNT(1) FROM OrderDetail OD
	WHERE [Status]=15
	...
	UNION ALL
	SELECT 0, 'All', SUM(InvoiceCount)+ISNULL(@ArchiveCount,0) AS StatusCount, 'S' AS Level FROM #temp 
