...
EXEC [DA_DriverRouteAcceptance_Delete] @UserKey,@JSOnString,@Status OUTPUT, @IntError OUTPUT, @Reason OUTPUT
SELECT @Status,@IntError,@Reason
*/

CREATE PROCEDURE	[dbo].[DA_DriverRouteAcceptance_Delete]
(
	@UserKey		INT = 714,
