	...
	Declare @RecCount	int, @RowNum int
		...
		SELECT
			...
			CASE 
				...
				END AS NextAction,
			OH.custKey,
			BR.BrokerName,OD.[Weight],OH.VesselName,OD.SealNo,OD.CutOffDate 
