...
BEGIN
	...
	WHILE(@i < = @n)
		BEGIN
			...
			IF(ISNULL(@FixVsNonFix,'') = 'Fixed' and ISNULL(@EffectiveDateFrom ,'') = '' )
			BEGIN
				SET @ISSuccess = 0
				SET	@RecordStatus = 0
