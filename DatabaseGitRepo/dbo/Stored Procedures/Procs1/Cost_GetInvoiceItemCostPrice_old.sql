...
/*
Declare @ItemKey int = 18, @InvoiceKey int = 151674,@ContainerNo varchar(50) = 'FDCU0419960',@JsonOutput	nvarchar(max) = '', @IsDebug bit = 1
Exec Cost_GetInvoiceItemCostPrice @itemkey, @InvoiceKey, @ContainerNo, @JsonOutput Output, @IsDebug
Select @InvoiceKey, @ItemKey, @JsonOutput
-- 84, 18, 209, 277, 207, 116, 103
*/
--select * from invoiceheader where invoiceno = '107304'
CREATE PRoc [dbo].[Cost_GetInvoiceItemCostPrice_old]  
(
	@ItemKey				int = 0,
	@InvoiceKey				int = 0,
