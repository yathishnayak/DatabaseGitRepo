...
CREATE PROCEDURE [dbo].[Get_VoucherList_V2_Praveen_Optimized20260211]
(
    @UserKey        INT,
...
BEGIN
    ...
    IF @OrderDateFrom IS NULL OR @OrderDateFrom IN ('0001-01-01', '1900-01-01')
        SET @OrderDateFrom = CASE WHEN @IsWithFilter = 0 THEN DATEADD(DAY, -90, GETDATE()) ELSE '2025-07-01' END;
    ...
    IF @DeliveryDateFrom IS NULL OR @DeliveryDateFrom IN ('0001-01-01', '1900-01-01')
        SET @DeliveryDateFrom = CASE WHEN @IsWithFilter = 0 THEN DATEADD(DAY, -90, GETDATE()) ELSE '2025-07-01' END;
    ...
    WHERE VH.VoucherDate > @VoucherDateThreshold
    ...
    ;WITH VoucherData AS (
        SELECT 
            ...
            'WK-' + CONVERT(VARCHAR, DATEPART(ISO_WEEK, VA.MinArrival)) AS weekNum,
