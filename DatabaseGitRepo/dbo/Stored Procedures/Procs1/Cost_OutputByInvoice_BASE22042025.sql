...
/*
	DECLARE @InvoiceKey int =0, @InvoiceNo Varchar(50) = '121902',   @JsonOutput nvarchar(max) ='',@Status	bit = 0 , @Reason	varchar(500) = '', @debug			bit = 1 
...
/*
	DECLARE @InvoiceKey int =0, @InvoiceNo Varchar(50) = '130975',   @JsonOutput nvarchar(max) ='',
			@Status	bit = 0 , @Reason	varchar(500) = '', @debug			bit = 1
	EXEC [Cost_OutputByInvoice] @InvoiceKey, @InvoiceNo, @JsonOutput OUTPUT, @Status OUTPUT, @Reason OUTPUT, @debug
	SELECT @JsonOutput, @Status, @Reason
*/
CREATE PRoc [dbo].[Cost_OutputByInvoice_BASE22042025]
(
	@InvoiceKey		int	= 0,
