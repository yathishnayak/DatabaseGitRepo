...
/*
	DECLARE @InvoiceKey int =0, @InvoiceNo Varchar(50) = '122876',   @JsonOutput nvarchar(max) ='',
			@Status	bit = 0 , @Reason	varchar(500) = '', @debug			bit = 1
	EXEC [Cost_OutputByInvoice_SHIVA] @InvoiceKey, @InvoiceNo, @JsonOutput OUTPUT, @Status OUTPUT, @Reason OUTPUT, @debug
	SELECT @JsonOutput, @Status, @Reason
*/
CREATE PRoc [dbo].[Cost_OutputByInvoice_SHIVA]
(
	@InvoiceKey		int	= 0,
