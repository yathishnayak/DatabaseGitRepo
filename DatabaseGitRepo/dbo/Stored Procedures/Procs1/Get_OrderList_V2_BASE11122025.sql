...
DECLARE 
	@UserKey INT=714,
	@JSONString NVARCHAR(MAX)='{"CustomerKeys":"","CSRKeys":"","CreatedUserKeys":"","MarketLocationKeys":"","PropertyKeys":"","EntryType":"","OrderTypeKey":"","StatusKey":0,"SearchText":"1UP2507244","PageNo":1,"PageSize":50,"IsAscending":false,"SortField":"CreateDate","outputType":"","Addrkey":0}',
	@Status BIT=0,@IsDebug		BIT = 0,
	@Reason VARCHAR(100)=''
EXec [Get_OrderList_V2_BASE11122025] @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT, @IsDebug
Select @Status, @Reason
**/
CREATE PROCEDURE [dbo].[Get_OrderList_V2_BASE11122025] -- [Get_OrderList_V2] @StatusKey=2, @PageNo = 1,@SearchText='WHSU5296890'
(
	@UserKey		INT = 714,
