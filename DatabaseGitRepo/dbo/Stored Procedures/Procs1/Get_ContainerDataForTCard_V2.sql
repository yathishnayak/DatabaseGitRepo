...
DECLARE 
		@userKey INT=953 ,
	@JSONString NVARCHAR(MAX)='{"selectedOrderDetailKeys":"","PageNo":1,"PageSize":10,"Ascending":true,"SearchText":"","IsExport":false,"isShowAll":false,"RangeName":"","CSRKey":0,"deliveryDateFrom":"2002-01-01T00:00:00.000Z","deliveryDateTo":"2050-01-01T00:00:00.000Z","pickupDateFrom":"2002-01-01T00:00:00.000Z","pickupDateTo":"2050-01-01T00:00:00.000Z","OrderNoFrom":"FL01202533733","OrderNoTo":"FL01202533734","CreatedDateFrom":"2002-01-01T00:00:00.000Z","CreatedDateTo":"2050-01-01T00:00:00.000Z","IsTransLoad":true,"StatusKey":0}',
	@Status BIT=0,@Reason VARCHAR(100)='',@IsDebug	BIT = 0,@JSONOutput NVARCHAR(MAX)=''
EXec [Get_ContainerDataForTCard_V2]  @userKey,@JSONString,@Status OUTPUT,@Reason OUTPUT, @IsDebug,@JSONOutput OUTPUT
Select @Status, @Reason
**/



CREATE Procedure [dbo].[Get_ContainerDataForTCard_V2]
(
	@UserKey		INT = 953,
...
BEGIN
   ...
   Declare
	...
	--	END	
		...
		@OrderNoTo			= 	OrderNoTo,		
		@selectedOrderDetailKeys	= 	selectedOrderDetailKeys,
	...
	WITH(
		...
		selectedOrderDetailKeys	VARCHAR(500)			'$.selectedOrderDetailKeys',
	...
	if(@ToOrderKey = 0) 
	begin
		set @ToOrderKey = @FromOrderKey+100
	End
	print @FromOrderKey
	print @ToOrderKey
	...
	SELECT
		...
		ML.MarketLocationKey,ML.MarketLocation,CC.ConsigneeName Consignee
