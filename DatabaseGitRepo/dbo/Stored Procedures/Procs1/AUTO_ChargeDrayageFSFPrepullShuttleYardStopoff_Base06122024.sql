...
CREATE PROC [dbo].[AUTO_ChargeDrayageFSFPrepullShuttleYardStopoff_Base06122024]  -- AUTO_ChargeDrayageFSFPrepullShuttleYardStopoff 167934, 1
(
...
BEGIN
	...
	Select @ContainerNo = ContainerNo, @OrderType = Ot.OrderType, @IncludeFSF = isnull(C.IncludeFSF,0)
