...
CREATE PROCEDURE [dbo].[Get_ContainerDetailByOrderDetailKey]    -- [Get_ContainerDetailByOrderDetailKey] 231288
(
...
BEGIN
	...
	SELECT
		...
		CASE 
			...
			isnull(CU.CustID,'') as CustID, ML.MarketLocationKey,MarketLocation,CC.ConsigneeName Consignee
