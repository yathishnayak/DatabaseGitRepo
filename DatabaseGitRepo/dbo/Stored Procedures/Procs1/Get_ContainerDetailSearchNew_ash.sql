...
CREATE PROCEDURE [dbo].[Get_ContainerDetailSearchNew_ash]   
...
BEGIN
	...
	--if @DeleveryDateFrom  is null set @DeleveryDateFrom  ='10/1/2022'
	...
	WHERE   
	 ...
	 --   select distinct OrderDetailkey,  Description into #vOrderContainerTypes  from vOrderContainerTypes
		...
		*/
		...
		--INTO #HazCont 
		--from #ContainerListData CL
		--inner join vOrderContainerTypes CT on CL.OrderDetailkey = CT.OrderDetailKey and 1<>1
