...
/*
	...
	SELECT @JsonOutput, @Status, @Reason
*/
CREATE PRoc [dbo].[Cost_Fetch_BI_DataByInvoice_BKP]
(
	@InvoiceKey		int	= 0,
            ...
            LineItemDetails = (
                SELECT 
                    ItemContainer = (
                        ...
                        FROM Cost_InvoiceItemSummary CI
                        FOR JSON PATH
                    )
                FOR JSON PATH
            ),
