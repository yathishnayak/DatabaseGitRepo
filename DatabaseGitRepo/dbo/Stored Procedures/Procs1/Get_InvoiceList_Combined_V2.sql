...
DECLARE 
	@UserKey INT=714,
	@JSONString NVARCHAR(MAX)='{"BookingNo":"NAM9436021","BOL":"","CustomerKey":0,"CustRefNo":""}'--'{"BOL":"","BookingNo":"NAM9436021"}'
	,@Status BIT=0,@IsDebug		BIT = 1
	,@Reason VARCHAR(100)=''
EXEC Get_InvoiceList_Combined_V2 @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT,@IsDebug
Select @Status, @Reason
**/

CREATE   Procedure [dbo].[Get_InvoiceList_Combined_V2] -- Get_InvoiceList_Combined_V2 @StatusKey=2, @PageNo = 1,@SearchText='WHSU5296890'
(
	@UserKey		INT = 714,
