...
CREATE PROC [dbo].[AUTO_ChargeDrayageFSFPrepullShuttleYardStopoff_BASE22042025]  -- AUTO_ChargeDrayageFSFPrepullShuttleYardStopoff 186924, 1
(
...
BEGIN
	...
	Exec AUTO_SELL_CalcAccessorialValueByOrderDetailKey @ItemKeys, @MarketKey, @OrderDetailKey, @ContainerNo, @Terminal, 
		...
		Begin try
			...
			IF(@CustKey = @SteamCustKey AND @OrderType = 'Empty' AND isnull(@IsYardStopOffItemExists,0) = 0)
			Begin
