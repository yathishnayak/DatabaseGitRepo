...
Declare 
    ...
    "SearchCriteriaKey": 0,
    "StatusKey": "1:",
    "PickupDateFrom": "2020-01-01T00:00:00.000Z",
    "PickupDateTo": "2050-01-01T00:00:00.000Z",
    "OutputType": "EXCEL"
}'
	EXEC [DispatchEntry_GetList_V3] @Userkey, @JSONSTRING, @Status OUTPUT, @Reason Output, @IsDebug
    SELECT @Status, @Reason


*/
CREATE PROCEDURE [dbo].[DispatchEntry_GetList_V3] -- DispatchEntry_GetList @CarrierStatus='4', @Status='1', @IsDebug = 1    
-- EXEC DispatchEntry_GetList @Status = 1, @PickupDateFrom = '2020-01-01T00:00:00.000Z', @PickupDateTo = '2050-01-01T00:00:00.000Z', @IsDebug = 1
(    
	@UserKey		INT = 0,
	@JSONString		NVARCHAR(MAX) = '',
	@Status			BIT	= 0 OUTPUT,
...
IF (@IsDebug = 1)
 ...
 OrderNo                CHAR(20)                    '$.OrderNo',    
 ContainerNo            VARCHAR(20)                 '$.ContainerNo',    
 LegType                CHAR(200)                   '$.LegType',        
 ...
 marketLocationKey      INT                         '$.MarketLocation', 
 ...
 End    
  ...
  SELECT   top 1000 WeekNum =  CASE WHEN RT.PickupDateFrom BETWEEN @StartDate AND @EndDate THEN  datepart(WEEKDAY, RT.PickupDateFrom )     
 ...
 WHERE ((Select count(1) from #OrderDetailkey_Temp) > 0 AND  OrderDetailKey in (Select OrderDetailKey from #OrderDetailkey_Temp)  ) OR ( (Select count(1) from #OrderDetailkey_Temp) =0  )) OD       
