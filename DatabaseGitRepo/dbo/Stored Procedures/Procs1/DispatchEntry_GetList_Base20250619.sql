...
CREATE PROCEDURE [dbo].[DispatchEntry_GetList_Base20250619] -- DispatchEntry_GetList @CarrierStatus='4', @Status='1', @IsDebug = 1
(
	@Weekday				CHAR(3)='',
	@Customer				VARCHAR(50)='',
	@OrderNo				VARCHAR(20)='',
...
BEGIN	
	...
	FROM dbo.OrderDetail OD   WITH (NOLOCK) 
		...
		LEFT JOIN (select ODI.OrderDetailKey,
					...
					LEFT JOIN Routes RTI ON (RTI.RouteKey=ODI.CurrentRouteKey)
