...
DECLARE 
	...
	@Status BIT=0,
	@Reason VARCHAR(100)=''
EXec Get_Invoice_Combined_V2_shiva @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT
Select @Status, @Reason
**/

CREATE   PROCEDURE [dbo].[Get_Invoice_Combined_V2_shiva]
(
	@UserKey		int,
...
BEGIN
	...
	select InvoiceKey, InvoiceOutput from #InvoiceKeys_temp FOR JSON PATH
