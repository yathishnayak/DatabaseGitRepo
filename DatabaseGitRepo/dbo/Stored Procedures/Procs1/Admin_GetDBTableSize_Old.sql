...
EXEC [Admin_GetDBTableSize] @UserKey,@JSOnString,@Status OUTPUT, @IntMessage OUTPUT, @ExtMessage OUTPUT, @Result1 OUTPUT, @Result2 OUTPUT
...
CREATE PRocEDURE [dbo].[Admin_GetDBTableSize_Old]
