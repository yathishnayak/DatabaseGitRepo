...
-----------------
			...
			--IF(ISNULL(@TruckType1 ,'') = '' )
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
			--		SET	@RecordRemarks = @RecordRemarks + 'Truck Type 1 Cannot be blank;'
			--	END
			--ELSE IF ((SELECT COUNT(*) FROM TruckType WHERE TruckType = @TruckType1 ) = 0)
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
			--		SET	@RecordRemarks = @RecordRemarks + 'Truck Type 1 does not exists in Masters;'
			--	END

			--IF(ISNULL(@TruckType1BaseCost ,'') = '' )
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
			--		SET	@RecordRemarks = @RecordRemarks + 'Truck Type 1 Base Cost Cannot be blank;'
			--	END
			--ELSE IF(ISNUMERIC(@TruckType1BaseCost) = 0)
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
			--		SET	@RecordRemarks = @RecordRemarks + 'Truck Type 1 Base Cost Should be a Number;'
			--	END
			--ELSE
			--	BEGIN
			--		SET @TruckType1BaseCost = CAST(@TruckType1BaseCost AS DECIMAL(18,2))
			--	END

			--IF(ISNULL(@TruckType1FSF,'') <> '' AND ISNUMERIC(@TruckType1FSF) = 0)
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
			--		SET	@RecordRemarks = @RecordRemarks + 'Truck Type 1 FSF Should be a Number;'
			--	END
			--ELSE IF (ISNUMERIC(@TruckType1FSF) = 1)
			--	BEGIN
			--		SET @TruckType1FSF = CAST(@TruckType1FSF AS DECIMAL(18,2))
			--	END
			...
			--	END
			--ELSE IF(REPLACE(ISNULL(@TruckType2BaseCost ,''),'0.0','') <> '' AND ISNULL(@TruckType2,'') = '' )
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
			--		SET	@RecordRemarks = @RecordRemarks + 'Truck Type 2 Cannot be blank;'
			--	END
			--ELSE IF ((SELECT COUNT(*) FROM TruckType WHERE TruckType = @TruckType2 ) = 0 AND ISNULL(@TruckType2 ,'') <> '')
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
			...
			--	END
			--ELSE IF(REPLACE(ISNULL(@TruckType3BaseCost ,''),'0.0','') <> '' AND ISNULL(@TruckType3,'') = '' )
			--	BEGIN
			--		SET @ISSuccess = 0
			--		SET	@RecordStatus = 0
