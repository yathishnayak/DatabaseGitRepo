--select * from invoiceheader where invoiceno = '151530'
CREATE PROCEDURE [dbo].[Auto_ReturnBaseInfo] 
--Auto_ReturnBaseInfo 190476
...
BEGIN
	...
	FROM (SELECT TOP 1000  
		...
		Y.yardid,
		P.TerminalKey as ShippingPortKey, P.TerminaID as ShippingPortID,
	...
	LEFT JOIN ShippingPortTerminals P WITH (NOLOCK) ON CASE WHEN L.FromLocation  = 'Port' THEN Rt.SourceAddrKey
