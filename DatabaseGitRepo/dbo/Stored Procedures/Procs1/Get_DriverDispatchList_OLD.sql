...
CREATE PROCEDURE [dbo].[Get_DriverDispatchList_OLD] -- Get_DriverDispatchList @StatusKey = 2
@StatusKey		 INT= 0,
@DriverKey		 INT= 0,
@OrderKey		 INT= 0,
...
BEGIN
	...
	SELECT  DISTINCT  0 AS OrderKey,0 AS OrderDetailKey,--oh.OrderNo,
		...
		--OrderNo,OrdCount,
		RT.ActualDeparture AS ActualDeparture,d.DriverID,d.FirstName,d.LastName,
