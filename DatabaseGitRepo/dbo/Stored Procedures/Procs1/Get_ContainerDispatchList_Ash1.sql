...
CREATE PROCEDURE [dbo].[Get_ContainerDispatchList_Ash1] -- Get_ContainerDispatchList @StatusKey=2, @InvoiceNo = '5'
@StatusKey		INT= 0,
@CustomerKey	INT= 0,
@OrderKey		INT= 0,
...
BEGIN
	...
	GROUP BY A.OrderKey,OrderNo,CustID,CustName,A.City,A.IsInvoiceApproved,A.StatusKey,A.OrderDetailKey,
		...
		, BrokerRefNo, IsFactored, isnull(A.VesselETA , '1/1/1900'), A.BalanceAmount
