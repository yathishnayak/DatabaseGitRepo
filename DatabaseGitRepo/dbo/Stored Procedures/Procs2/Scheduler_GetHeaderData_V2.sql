/*  
 ...
 @JSONString NVARCHAR(MAX)='{"OrderDetailKey":175659}',@Status BIT=0,@IsDebug  BIT = 0, @Reason VARCHAR(100)=''  
 Exec Scheduler_GetHeaderData_V2 @UserKey,@JSONString, @IsDebug,@Status OUTPUT,@Reason OUTPUT  
 Select @Status, @Reason  
*/  
  
CREATE PROCEDURE [dbo].[Scheduler_GetHeaderData_V2]  
(  
	 @UserKey  INT=512,  
...
BEGIN  
 ...
 INSERT INTO #tmp  
 Exec OrderDetail_GetStopList_V2 @UserKey,@JSONString,@JsonOutput OUTPUT,@Status OUTPUT,@Reason OUTPUT, 0  
