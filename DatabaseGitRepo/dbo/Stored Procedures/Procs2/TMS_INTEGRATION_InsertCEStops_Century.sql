...
CREATE PROC [dbo].[TMS_INTEGRATION_InsertCEStops_Century]
AS
...
BEGIN
	...
	WHERE			rtn.LocationType = 'CE' and sl.stopkey is null -- and FH.DataKey = 13142  
	...
	SELECT			ContainerKey,'Chassis Split - Pickup', AddrName, 3, 'CE', 3,
					address1,Address2, City,State, Country, ZipCode, equipmentNumber, equipmentTypeCode,0, 'CE'
	FROM			#TMP
