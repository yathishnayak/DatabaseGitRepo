...
Exec GlobalSearch_Chassis_Base30092025 @UserKey, @JsonString, @Status output, @Reason output, @IsDebug
Select @Status Status, @Reason Reason
*/

Create PROCEDURE [dbo].[GlobalSearch_Chassis_Base30092025]
(
	@UserKey	 INT = 0,
...
WHERE 
  (@ChassisNo IS NULL OR Sub.ChassisNo LIKE '%' + @ChassisNo + '%')
    AND (@OrderDetailKey IS NULL OR OrderDetailKey = @OrderDetailKey)
