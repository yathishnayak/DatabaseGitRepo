...
CREATE PROC [dbo].[TMS_INTEGRATION_InsertSTStops_Century]
AS
...
BEGIN
	...
	WHERE			rtn.LocationType = 'ST'   and sl.stopkey is null -- and FH.DataKey = 13142  
	...
	SELECT			ContainerKey,'Ship To', AddrName, 2, 'ST', 2,
