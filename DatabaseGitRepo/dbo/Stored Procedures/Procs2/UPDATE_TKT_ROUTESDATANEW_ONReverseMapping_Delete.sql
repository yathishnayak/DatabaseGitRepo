...
CREATE PROC [dbo].[UPDATE_TKT_ROUTESDATANEW_ONReverseMapping_Delete] -- [UPDATE_TKT_ROUTESDATANEW_ONReverseMapping_Delete] 234049
(
	@OrderKey	int
)
AS
...
SELECT		Orderkey, OrderTypeKey, CustKey, CreateDate
INTO		#OrderHeader
