...
CREATE proc [dbo].[Sell_GetStopOffValue] -- Sell_GetStopOffValue 2, 1, 6
(
	@MarketKey		int,
	@ZoneKey		int,
	@TerminalKey	int,
...
Begin
	...
	LEft Join COST_CostDataOutput_StopOff PP on ml.MarketLocation = PP.Market and PP.Terminal = T.PriceGrouping
