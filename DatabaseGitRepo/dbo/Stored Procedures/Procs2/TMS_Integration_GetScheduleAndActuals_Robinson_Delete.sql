...
CREATE proc [dbo].[TMS_Integration_GetScheduleAndActuals_Robinson_Delete] 
-- TMS_Integration_GetScheduleAndActuals_Robinson_Delete 114181 ,1505
(
	@TMS_OrderKey	int,
	@DataKey		int
)
...
BEGIN
	...
	Begin
		...
		from (
			...
			from (SELECT * FROM TKT_RouteDataNew) DT
