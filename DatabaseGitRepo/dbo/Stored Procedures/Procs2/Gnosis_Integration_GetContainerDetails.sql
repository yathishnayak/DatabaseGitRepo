...
set @JsonString = '{"ThisWeek":false,"Today":false,"Arrived":false,"NextWeek":false,"ThisMonth":false,"DemurrageStatus":false,"DetentionStatus":false,"NearingDemurrage":false,"WithDemurrage":false,"WithDetention":false,"Terminal":"","PageNo":1,"PageSize":50,"SortField":"ContainerNo","IsAscending":true,"CSMKeys":"","CSRKeys":"","ContainerStatusKeys":"","CustKeys":"","SalesPersonKeys":"","HoldStatus":"","TerminalNames":"","MarketKeys":"Chicago:","SearchText":"","DischargeYN":"","IsScheduledYN":"","PickupAvailable":"","HoldTypes":""}'
exec Gnosis_Integration_GetContainerDetails @UserKey, @JSONString, @Status output, @Reason output
select @Status, @Reason
*/
CREATE PROCEDURE	[dbo].[Gnosis_Integration_GetContainerDetails] -- Gnosis_Integration_GetContainerDetails 'GAOU6974889'
(
	@UserKey		int,
...
--					,'' Custom_detention_demurrage_calc
	...
	LEFT JOIN		ORDERHEADER OH WITH (NOLOCK) ON OD.ORDERKEY = OH.OrderKey AND CD.Container_journey_start_key = CD.Container_number + '_' + OH.BillOfLading
