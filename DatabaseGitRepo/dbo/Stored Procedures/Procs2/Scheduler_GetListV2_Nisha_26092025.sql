...
DECLARE 
	...
	{
	"ContainerNo": "","ThisWeek": false,"Today": false,"Arrived": false,"NextWeek": false,"ThisMonth": false,"DemurrageStatus": false,"DetentionStatus": false,"NearingDemurrage": false,"WithDemurrage": false,"WithDetention": false,"Terminal": "","PageNo": 1,"PageSize": 50,"SortField": "OrderNo",
	"IsAscending": true,"CSMKeys": "","CSRKeys": "","ContainerStatusKeys": "","CustKeys": "","SalesPersonKeys": "","HoldStatus": "","TerminalNames": "","TerminalCodes": "","VesselIMOs": "","MarketKeys": "","SearchText": "","DischargeYN": "","PickupAvailable": "","HoldTypes": "","PickUpFrom": null,"PickUpTo": null,"StatusKey": 1,"OrderType": "","Deliverylocationkeys": "","Tracking": "","RangeName": ""
}',
	@Status BIT=0, @IsDebug bit = 0,
	@Reason VARCHAR(100)=''
EXec Scheduler_GetListV2_Nisha_26092025 @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT, @IsDebug
Select @Status, @Reason
**/
Create PROCEDURE [dbo].[Scheduler_GetListV2_Nisha_26092025]   
	@UserKey		int,
	@JSONString		nvarchar(max),
	@Status			bit	= 0 output,
...
INSERT INTO SqlExecutionTimeLog
	...
	END
		...
		--AND(ISNULL(@RangeName,'') ='' OR   (@RangeName = 'Past'   AND CAST(RT.PickUpDateFrom AS DATE) < @StartDate)
  --  OR (@RangeName = 'Future' AND CAST(RT.PickUpDateFrom  AS DATE)> @StartDate)
  --OR (@RangeName NOT IN ('Past', 'Future') AND CAST(RT.PickUpDateFrom  AS DATE) BETWEEN @StartDate AND @EndDate) order by routekey desc 
		--)
