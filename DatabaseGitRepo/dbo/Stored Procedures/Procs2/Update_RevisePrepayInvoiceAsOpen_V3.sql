...
DECLARE 
	@UserKey INT = 1144,
	@JSONString NVARCHAR(MAX)= '{"InvoiceKey" : 52}',
	@Status	BIT = 0, 
	@IsDebug BIT = 0, 
	@Reason	VARCHAR(100)=''
	EXEC [Update_RevisePrepayInvoiceAsOpen_V3] @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT, @IsDebug
	SELECT @Status AS Status, @Reason AS Reason
*/
CREATE PROCEDURE [dbo].[Update_RevisePrepayInvoiceAsOpen_V3]
(
	@UserKey		INT = 1144,
...
BEGIN
	...
	SELECT GETDATE(),@UserName,'Order',IH.OrderNo,IH.OrderKey,null,'Text','PrePay Invoice ' + IH.PPInvoiceNo + ' Revised as Open'
