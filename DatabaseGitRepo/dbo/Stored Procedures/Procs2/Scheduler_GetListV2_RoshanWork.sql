...
DECLARE 
	...
	@Reason VARCHAR(100)=''
EXec [Scheduler_GetListV2_RoshanWork] @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT, @IsDebug
Select @Status, @Reason
**/
CREATE PROCEDURE [dbo].[Scheduler_GetListV2_RoshanWork]   
	@UserKey		int,
...
BEGIN
	...
	SELECT * INTO #OrderDetail FROM OrderDetail
	...
	SELECT
		...
		SELECT COUNT(*) FROM #TempAll
		SELECT COUNT(*) FROM #TempAll WHERE statuskey in (1,2,3,6,7,9,12,14)
