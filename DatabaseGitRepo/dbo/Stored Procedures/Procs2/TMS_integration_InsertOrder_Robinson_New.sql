...
*/
CREATE procEDURE [dbo].[TMS_integration_InsertOrder_Robinson_New]
(
	@SiteId				varchar(50),
	@DataKey			int,
	@Json				nvarchar(max),
...
BEGIN
	...
	Begin Try
		...
		insert into #Header ( DataKey, FileProcessKey, TMS_OrderKey, TMS_CustKey, TMS_SourceAddrKey, TMS_DestinationAddrKey, 
			...
			ErrorLine,L11Lines, notes, Consignee, Sender)
		...
		Begin
			...
			INSERT INTO dbo.OrderHeader(OrderNo, OrderDate,Csrkey, CustKey,   
						...
						BillToAddrKey,ETADate,BaseRateAmount, SenderInfo )
			Select
						...
						,@BillToAddrKey,ETADate,@BaseRateAmount, Sender 
			From #Header
