...
CREATE PROC [dbo].[TMS_INTEGRATION_InsertCBStops_Century]
AS
...
BEGIN
	...
	WHERE			rtn.LocationType = 'CB'   and sl.stopkey is null -- and FH.DataKey = 13142  
	...
	SELECT			ContainerKey,'Chassis Split - Return', AddrName, 4, 'CB', 4,
					address1,Address2, City,State, Country, ZipCode, equipmentNumber, equipmentTypeCode,0,'CB'
	FROM			#TMP
