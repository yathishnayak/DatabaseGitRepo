...
/* --19907, 25335 -- Acc Rate : SMB- 47507, ENT- 47502
	DECLARE @InvoiceKey int =97923, @InvoiceNo Varchar(50) = '',   @JsonOutput nvarchar(max) ='',@Status	bit = 0 , @Reason	varchar(500) = '' ,
...
*/
CREATE PRoc [dbo].[Sell_OutputByInvoice_PRev20240606]
(
	@InvoiceKey			int	= 0,
...
BEGIN
	...
	select ih.InvoiceKey, IH.InvoiceNo, ID.InvoicelineKey,ID.Container, ID.ItemKey,I.ItemID, I.Description, 
		...
		I.DryRunType, M.ItemKey as MITemKey, M.Description as MDescription
	into #ItemInfo
