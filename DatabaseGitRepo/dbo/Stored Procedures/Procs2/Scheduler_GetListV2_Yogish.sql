...
BEGIN
	...
	SELECT A.UUID, Field_name, Field_value INTO #Gnosis_Integration_ContainerCustomer_Final
...
CREATE TABLE [dbo].#TempAll(
	...
	[ContainerID] [varchar](200)  NULL,
	[ContainerSizeKey] [smallint]  NULL,
	[LastFreeDay] [datetime] NULL,
	[PickupDate] [smalldatetime] NULL,
	[PickupTime] [varchar](200) NULL,
	[DropOffDate] [smalldatetime] NULL,
	[DropOffTime] [varchar](200) NULL,
	[Status] [varchar](200)  NULL,
	[StatusKey] [int] NULL,
	[OrderType] [varchar](100)  NULL,
	[BillOfLading] [varchar](200)  NULL,
	[BookingNo] [varchar](200)  NULL,
	[BrokerRefNo] [varchar](200)  NULL,
	[ContainerSize] [varchar](200)  NULL,
	...
	[Source_ZipCode] [varchar](200) NULL,
	[Source_Country] [varchar](50) NULL,
	...
	[Destination_ZipCode] [varchar](200) NULL,
	[Destination_Country] [char](3) NULL,
	[B_AddrName] [varchar](255)  NULL,
	[B_Address1] [varchar](255)  NULL,
	[B_City] [varchar](255)  NULL,
	[B_State] [varchar](255)  NULL,
	[B_ZipCode] [varchar](200)  NULL,
	[B_Country] [char](3)  NULL,
	[R_AddrName] [varchar](500)  NULL,
	[R_Address1] [varchar](500)  NULL,
	[R_City] [varchar](500)  NULL,
	[R_State] [varchar](500)  NULL,
	[R_ZipCode] [varchar](200)  NULL,
	[R_Country] [varchar](200)  NULL,
	[VesselETA] [datetime] NULL,
	[IsLinked] [bit] NOT NULL,
	[LinkedContainerNo] [varchar](200)  NULL,
	[NextAction] [varchar](200) NULL,
	[custKey] [int] NOT NULL,
	[BrokerName] [varchar](300) NULL,
	...
	[MarketLocation] [varchar](200)  NULL,
	[Consignee] [varchar](100) NULL,
	[SteamShipLine] [varchar](200) NULL,
	[SenderInfo] [varchar](100) NULL,
	[SCAC] [varchar](200) NULL,
	[Dischargedate] [varchar](200) NULL,
	[HoldStatus] [varchar](200) NULL,
	[LiveDrop] [varchar](1) NOT NULL,
	[DelayReasonCode] [nvarchar](max) NULL,
	[PUDelayedCodeKey] [int] NULL,
	[AvailableforPickup] [varchar](200) NULL,
	[AvailableforPickupDate] [varchar](200) NULL,
	[IsEditDelayReasonCode] [smallint] NULL,
	[PrepullDelayedCodeKEy] [int] NULL,
	[PrepullDelayedCode] [nvarchar](max) NULL,
	[IsEditPrepullReasonCode] [smallint] NULL,
	[Location_at_terminal] [varchar](200) NULL,
	[Tracking] [smallint] NULL,
	[Pod_terminal_name] [varchar](200) NULL,
	[CTF] [varchar](200) NULL,
	[Customs] [varchar](200) NULL,
	[Line] [varchar](200) NULL,
	[Other] [varchar](200) NULL,
	[TMF] [varchar](200) NULL,
	[HoldType] [varchar](200)  NULL,
	[Customer] [varchar](200) NULL,
	[OrderCSR] [varchar](200) NULL,
	[SalesPersonKey] [int] NULL,
	[Pickup_appointment_dt] [varchar](200) NULL,
	[LinkedUserKey] [int] NULL,
	[DeliveryLocationKey] [int] NULL,
	[NoTrackingRemarks] [varchar](200)  NULL,
	[PrepullRCKeys] [nvarchar](max) NULL,
	[PUDealyedRCKeys] [nvarchar](max) NULL,
	[IsDataSelected] [smallint] NULL,
	[IsSelectedStatusKey] [smallint] NULL,
	[ID] [bigint] NULL
 ...
 SELECT * INTO #Address FROM [Address]
	...
	IF ISNULL(@SearchText,'') = ''
	BEGIN		
		SELECT A.OrderDetailkey,A.ContainerNo,A.ContainerID,A.ContainerSizeKey,A.LastFreeDay,A.IsLinked,A.LinkedContainerNo,
		A.SealNo,A.CutOffDate,A.Weight,A.IsEmpty,A.DriverNotes,A.SchedulerNotes,A.IsTMF,A.TotalLegs,A.CurrentLegNo,A.CompleteDate
		,A.isStreetTurn,A.StreetTurnSetDate,A.PUDelayedCodeKey,A.PrepullDelayedCodeKEy,A.CurrentRouteKey,A.CreateUserKey,A.StreetTurnSetUser,
		K.OrderKey,K.[Status],K.CustKey,K.CsrKey,K.BrokerKey,K.OrderTypeKey,K.SourceAddrKey,K.DestinationAddrKey,K.BillToAddrKey
			,K.ReturnAddrKey,K.PriorityKey,K.CSRManagerKey,K.MarketLocationKey,K.SteamShipLinekey,K.SalesPersonKey
			,K.VesselName,K.SenderInfo,K.Consignee,K.BillOfLading,K.BrokerRefNo,K.BookingNo,K.OrderDate,K.OrderNo			
		INTO #OrderDetail FROM OrderDetail A 
			INNER JOIN OrderHeader K ON K.OrderKey=A.OrderKey
		WHERE A.status IN (1,2,3,7,9,6,12,14, 10) AND OrderDate >='8/1/2024' 


		select A.* INTO #Routes from [Routes]  A  inner join #OrderDetail L ON l.OrderDetailKey=A.OrderDetailKey
		

		--SELECT OrderKey,[Status],CustKey,CsrKey,BrokerKey,OrderTypeKey,SourceAddrKey,DestinationAddrKey,BillToAddrKey
		--	,ReturnAddrKey,PriorityKey,CSRManagerKey,MarketLocationKey,SteamShipLinekey,SalesPersonKey
		--	,VesselName,SenderInfo,Consignee,BillOfLading,BrokerRefNo,BookingNo,OrderDate,OrderNo INTO #OrderHeader
		--FROM dbo.OrderHeader WITH (NOLOCK) 
		--WHERE OrderDate >='8/1/2024'
		INSERT INTO #TempAll
		SELECT
			isnull(OD.OrderKey,0) OrderKey,
			isnull(OD.OrderDate,'1900-01-01') as OrderDate,
			isnull(OD.OrderDetailkey,0) as OrderDetailkey,
			isnull(OT.OrderTypeKey,0) as OrderTypeKey,
			isnull(OD.OrderNo,'') as OrderNo,
			...
			isnull(OD.BillOfLading,'') AS BillOfLading,
			isnull(OD.BookingNo,'') AS BookingNo,
			isnull(OD.BrokerRefNo,'') as BrokerRefNo,
			...
			CASE 
				...
				END AS NextAction,
			OD.custKey,BR.BrokerName,OD.[Weight],OD.VesselName,OD.SealNo,OD.CutOffDate 
			...
			isnull(OD.CSRManagerKey ,CM.CsrKey) as CSRManagerKey,
			...
			, OD.Consignee, SL.LineName AS SteamShipLine, OD.SenderInfo,
			...
			PrepullRCKeys=(Stuff((SELECT ', ' + CAST(ODPPRC.PrepullRCKey AS VARCHAR)
			 ...
			 ROW_Number() Over(order by OD.OrderDetailKey) as ID-- into #TempAll1
		FROM  #OrderDetail OD							
			--INNER JOIN #OrderHeader OH ON OH.OrderKey=OD.OrderKey
			INNER JOIN dbo.OrderStatus OS			WITH (NOLOCK)	ON OS.[Status]=OD.[Status]			
			...
			LEFT JOIN dbo.[Broker]  BR				WITH (NOLOCK)	ON BR.BrokerKey=OD.BrokerKey
			LEFT JOIN DBO.Customer CU				WITH (NOLOCK)	ON OD.CustKey = CU.CustKey
			LEFT JOIN dbo.CSR CR					WITH (NOLOCK)	ON CR.CsrKey= ISNULL(OD.CsrKey, CU.CSRKey)
			LEFT JOIN  dbo.OrderType OT				WITH (NOLOCK)	ON OT.OrderTypeKey = OD.OrdertypeKey 
			LEft join #Routes RT					WITH (NOLOCK)   ON  OD.CurrentRouteKey = Rt.RouteKey
			LEFT JOIN #Address SR					WITH (NOLOCK)	ON	SR.AddrKey=isnull(OD.SourceAddrKey, OD.SourceAddrKey)
			LEFT JOIN #Address DT					WITH (NOLOCK)	ON	DT.AddrKey=isnull(OD.DestinationAddrKey, OD.DestinationAddrKey)
			LEFT JOIN #Address BT					WITH (NOLOCK)	ON	BT.AddrKey=OD.BillToAddrKey
			LEFT JOIN #Address RET					WITH (NOLOCK)	ON	RET.AddrKey=OD.ReturnAddrKey
			...
			LEFT JOIN  dbo.[Priority] PT			WITH (NOLOCK)	ON PT.PriorityKey=OD.PriorityKey
			LEFT Join DBO.[User] UU					WITH (NOLOCK)	ON OD.CreateUserKey = uu.UserKey
			LEft join ( SELECT OrderDetailKey,ContainerTypeKey 
						FROM vContainerType WITH (NOLOCK)  
						WHERE TypeID = 'Transload' )  CT  ON CT.OrderDetailKey = OD.OrderDetailKey
			...
			LEFT JOIN ( SELECT OrderDetailKey,ContainerTypeKey 
						FROM vContainerType WITH (NOLOCK) 
						WHERE TypeID = 'Hazard' ) HZ ON HZ.OrderDetailKey = OD.OrderDetailKey --AND CT.TypeID = 'Hazard'
			...
			LEft Join CSR CM						WITH (NOLOCK)   ON CM.CsrKey = isnull(ISNULL(OD.CSRManagerKey,CU.CSRManagerKey),CR.CsrKey)
			LEFT JOIN SalesPerson SP				WITH (NOLOCK)   ON SP.SalesPersonKey =  ISNULL( OD.SalesPersonKey, CU.SalesPersonKey)
			LEFT JOIN MarketLocation ML				WITH (NOLOCK)   ON OD.MarketLocationKey =  ML.MarketLocationKey
			LEFT JOIN SteamShipLine SL				WITH(NOLOCK)    ON SL.LineKey = OD.SteamShipLinekey
	...
	FROM  dbo.OrderDetail OD					WITH (NOLOCK)
		INNER JOIN	#OrderDetailKeys ODK						ON od.OrderDetailKey =ODK.OrderDetailKey
		...
		LEft join ( SELECT OrderDetailKey,ContainerTypeKey 
					FROM vContainerType WITH (NOLOCK) 
					WHERE TypeID = 'Transload') CT ON CT.OrderDetailKey = OD.OrderDetailKey --and Ct.TypeID = 'Transload'
		LEft join #Address RA					with (nolock)	ON RT.DestinationAddrKey = RA.AddrKey
		LEFT join Leg L							WITH (NOLOCK)   ON RT.LegKey = l.LegKey
		LEFT JOIN #Address RP					WITH (NOLOCK)   ON RT.SourceAddrKey = RP.AddrKey
		LEFT JOIN ( SELECT OrderDetailKey,ContainerTypeKey 
