...
exec Gnosis_GetDynamicFiltersList_Scheduler_Shiva @UserKey, @JSONString, @Status output, @Reason output
select @Status, @Reason
*/
CREATE PROCEDURE [dbo].[Gnosis_GetDynamicFiltersList_Scheduler_shiva]   
(
	@UserKey		int,
