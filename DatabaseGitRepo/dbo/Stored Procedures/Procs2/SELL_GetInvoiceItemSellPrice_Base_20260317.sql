/*
Declare @ItemKey int = 18,@InvoiceKey int = 229402,@ContainerNo varchar(50) = 'IMPT2511609',
	@JsonOutput	nvarchar(max) = '', @IsDebug bit =0
Exec SELL_GetInvoiceItemSellPrice_Base_20260317 @itemkey, @InvoiceKey, @ContainerNo, @JsonOutput Output, @IsDebug
Select @InvoiceKey, @ItemKey, @JsonOutput
-- 84, 18, 209, 277, 207, 116, 103
*/
--select * from invoiceheader where invoiceno = '54154'
CREATE PRoc [dbo].[SELL_GetInvoiceItemSellPrice_Base_20260317]  
(
	@ItemKey				int = 0,
	@InvoiceKey				int = 0,
...
BEGIN
	...
	SEt @JsonOutput = ''
	select @MarketKey =  isnull(OH.MarketLocationKey, C.MarketLocationKey) ,
