...
CREATE PROC [dbo].[TMS_INTEGRATION_InsertCPStops_Century]
AS
...
BEGIN
	...
	WHERE			rtn.LocationType = 'CP'   and sl.stopkey is null--    and FH.DataKey = 7458  
	...
	SELECT			ContainerKey,'Linked Container', AddrName, 2, 'CP', 2,
					address1,Address2, City,State, Country, ZipCode, equipmentNumber, equipmentTypeCode,0,'ST'
	FROM			#TMP
