...
*/
CREATE PROC [dbo].[Sell_OutputByInvoice_Sumantha]
(
	@InvoiceKey			int	= 0,
	...
	BEGIN
		...
		--Begin
			...
			where (City = @city OR City is null) and 
				...
				ORDER BY convert(datetime, EffectiveDate) DESC, OutputDataKey Desc, city DESC, State DESC, Zip Desc, LocationName DESC
