...
DECLARE @UserKey INT = 953,
      ...
      '{ "OrderKey": 0,"CustKey": 0, "OrderDateFrom": null,"OrderDateTo": null, "OrderNo": "CENTU2505347", "ContainerNo": "", "InvoiceNo": "","InvoiceKey": 0, "BOLNo": "","TermDateFrom": null,"TermDateTO": null,"SearchText": ""}',
        @IsDebug BIT = 1,
        @Status BIT = 0,
        @Reason NVARCHAR(1000) = '';

EXEC PendingToInvoice_GetReport_V2
     @UserKey,
     @JsonString,
     @Status OUTPUT,
     @Reason OUTPUT,
...
CREATE PROCEDURE [dbo].[PendingToInvoice_GetReport_V2]
(
	@UserKey		INT = 953,
	@JSONString		NVARCHAR(MAX) = '',
	@Status			BIT	= 0 OUTPUT,
	@Reason			VARCHAR(1000) = '' OUTPUT,
	@IsDebug		BIT = 0 OUTPUT
...
DECLARE 
	...
	@DeliVeryDateFom  DATE = '2020-01-01',
	@DelivaryDateTo   DATE = '2099-12-31',
	@OrderNo          VARCHAR(50) = '',
	...
	@TermDateFrom     DATE = '2020-01-01',
	@TermDateTO       DATE = '2099-12-31';
...
WITH (
	...
	BOLNo            VARCHAR(30)   '$.BOL',
	SearchText       VARCHAR(50)   '$.SearchText',
	TermDateFrom     DATE          '$.TermDateFrom',
	TermDateTO       DATE          '$.TermDateTo'
);
