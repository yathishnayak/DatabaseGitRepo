...
BEGIN  
 ...
 LocationType  ,  
 RefNo    ,  
 SchedulePickUp,ScheduleDelivery,ActualPickUp,ActualDelivery,  strActualPickUp,strActualDelivery,
 ...
 WITH (  
   ...
   strActualPickUp   VARCHAR(50)  '$.ActualPickupDate',  
   strActualDelivery   VARCHAR(50)  '$.ActualDeliveryDate', 
...
print'geer'  
 ...
 update #tempstopsdata SET
	strActualPickUp = Case when strActualPickUp is null then null else  REPLACE( SUBSTRING(strActualPickUp,1,19),'T',' ') END,
	strActualDelivery = Case when strActualDelivery is null then null else  REPLACE( SUBSTRING(strActualDelivery,1,19),'T',' ') END
 ...
 -- INTO @StopName  
  ...
  print '1'
   ...
   SELECT   OrderDetailKey,@StopTypeKey,StopName,@UserKey,GETDATE(),  
       ...
       strActualPickUp, case when ActualPickUp is null then null else @UserKey end,  
       ...
       strActualDelivery, case when ActualDelivery is null then null else @UserKey end,  
  ...
  print '2-1'
   ...
   SET  StopTypeKey=@StopTypeKey,StopAddrKey=TD.StopAddrKey,StopNumber=TD.StopNo,  
     ...
     ActualPickupDate= TD.strActualPickUp, -- REPLACE(substring(TD.ActualPickUp,1,19),'T',' '),
     ...
     ActualDeliveryDate=TD.strActualDelivery, --  REPLACE(substring(TD.ActualDelivery,1,19),'T',' '),
