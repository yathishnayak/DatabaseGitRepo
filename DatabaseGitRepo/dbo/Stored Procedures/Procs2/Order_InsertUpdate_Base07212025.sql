...
DECLARE @UserKey INT=512,
	@JSONString NVARCHAR(MAX)='{"OrderKey":0,"OrderType":1,"csrkey":73,"IsEdit":false,"UploadedDocumentKeyList":"","CSRManagerKey":40,"orderdetailslist":[{"RowIndex":1,"ContainerNo":"3PLI2509516","ContainerSize":"3","ContainerSizeDesc":"40DRY","Chassis":"","SealNo":"","Weight":"2.","WeightUnit":"1","WeightUnitDesc":"LB","Containerprops":[{"ContainerTypeKey":11,"OrderDetailKey":0,"IsSelected":true,"TypeDescription":"FTL"}],"Properties":"FTL,","OrderTypeName":"Import","Priority":"reg","Comments":"","OrderType":"Import","OrderTypeKey":1,"PriorityKey":4,"Ship_From":"BERTH 233 TERMINAL 389 Terminal Way","StopDetailKeySF":41386,"Ship_To":"3PL-Center 3850 ROYAL AVE STE B","StopDetailKeyST":24328,"LocTypeSF":"Port","LocTypeST":"Customer","containerid":"3PL2505XXX_3PLI2509516","IsShipFromEditable":false,"IsStopOffBEditable":false,"IsStopOffAEditable":false,"IsReturnToEditable":false,"IsShipToEditable":false}],"PriorityKey":4,"OrderNo":"3PL2505XXX","ordertypedescription":"Import","MarketLocationKey":2,"SourceAddressKey":41386,"DestinationAddressKey":24328,"CustName":"3PL Center LLC (JCT)","CustKey":2996,"BillToAddressKey":24194,"ACH_Enabled":false,"SalesPersonKey":4,"CreditLimitAvailable":0,"OrderDate":"2025-05-23T10:35:03.159Z","PriorityName":"reg","OrderStops":[{"StopTypeKey":1,"StopTypeName":"Pickup","StopTypeShortcode":"SF","IsFoundationStop":true,"OrderBy":1,"IsActive":true,"CreateDate":"2024-12-17T02:47:47.213","CreateUserKey":29,"CreateUserName":"Shiva Prasad","UpdateUserName":"Shiva Prasad","StopNumber":1,"StopName":"BERTH 233 TERMINAL","AddressLine1":"389 Terminal Way","City":"San Pedro","State":"CA","ZipCode":"90731","Country":"US ","StopAddrKey":41386,"LocationType":"Port"},{"StopTypeKey":2,"StopTypeName":"Stop","StopTypeShortcode":"AF","IsFoundationStop":false,"OrderBy":2,"IsActive":true,"CreateDate":"2024-12-17T02:47:47.213","CreateUserKey":29,"CreateUserName":"Shiva Prasad","UpdateUserName":"Shiva Prasad"},{"StopTypeKey":3,"StopTypeName":"Delivery","StopTypeShortcode":"ST","IsFoundationStop":true,"OrderBy":3,"IsActive":true,"CreateDate":"2024-12-17T02:47:47.213","CreateUserKey":29,"CreateUserName":"Shiva Prasad","UpdateUserName":"Shiva Prasad","StopNumber":2,"StopName":"INNOVATIVE TERMINAL (BARRACUDA)","AddressLine1":"950 BARRACUDA ST.","City":"SAN PEDRO","State":"CA","ZipCode":"90731","Country":"USA","StopAddrKey":24328,"LocationType":"Customer"},{"StopTypeKey":4,"StopTypeName":"Stop","StopTypeShortcode":"AT","IsFoundationStop":false,"OrderBy":4,"IsActive":true,"CreateDate":"2024-12-17T02:47:47.213","CreateUserKey":29,"CreateUserName":"Shiva Prasad","UpdateUserName":"Shiva Prasad"},{"StopTypeKey":5,"StopTypeName":"Return","StopTypeShortcode":"RT","IsFoundationStop":true,"OrderBy":5,"IsActive":true,"CreateDate":"2024-12-17T02:47:47.213","CreateUserKey":29,"CreateUserName":"Shiva Prasad","UpdateUserName":"Shiva Prasad"}]}',
	@Status BIT=0,@IsDebug		BIT = 0, 
	@JsonOutput nvarchar(max) ='', 	@Reason VARCHAR(100)=''
Exec Order_InsertUpdate @UserKey,@JSONString,@JsonOutput OUTPUT,@Status OUTPUT,@Reason OUTPUT, @IsDebug
Select @JsonOutput, @Status, @Reason
**/
CREATE PROC [dbo].[Order_InsertUpdate_Base07212025]
(
	@UserKey			int,
...
BEGIN
    ...
    WITH (
		...
		orderHeaderCommentBOList		nvarchar(max)	'$.orderHeaderCommentBOList' as JSON,
		OrderDetailCommentBOList		nvarchar(max)	'$.OrderDetailCommentBOList' as JSON,
		files							nvarchar(max)	'$.files' as JSON,
		BillToAddressBO					nvarchar(max)	'$.BillToAddressBO' as JSON,
		SourceAddressBO					nvarchar(max)	'$.SourceAddressBO' as JSON,
		DestinationAddressBO			nvarchar(max)	'$.DestinationAddressBO' as JSON,
		ReturnAddressBO					nvarchar(max)	'$.ReturnAddressBO' as JSON,
		BrokerAddressBO					nvarchar(max)	'$.BrokerAddressBO' as JSON,
		orderdetailslist				nvarchar(max)	'$.orderdetailslist' as JSON,
		...
		orderdetails_2					nvarchar(max)	'$.orderdetails' as JSON,
    ...
    WITH (
		...
		Comments							varchar(500)	'$.Properties',
		...
		BEGIN TRY 
			...
			Begin
				...
				Exec dbo.Insert_OrderHeader 	@OrderNo, @OrderDate, @CustKey, @BillToAddressKey, @Csrkey, @CSRManagerKey, 
					@SalesPersonKey, @SourceAddressKey, @DestinationAddressKey, @ReturnAddressKey, @OrderType, @Status, 
					...
					@SteamShipLinekey, @Consignee, @OrderKey OUTPUT,@SenderInfo
				print 'OrderKey'
				print @OrderKey
				update #OrderStopsList set orderkey =  @OrderKey
				update #orderdetailslist set OrderKey = @OrderKey
			...
			Begin
				...
				Exec dbo.Update_OrderHeader @OrderKey, @CustKey, @BillToAddressKey, @CsrKey, @CSRManagerKey, @SalesPersonKey, 
					@SourceAddressKey, @DestinationAddressKey, @ReturnAddressKey, @OrderType, @OrderStatus, @BrokerKey, 
					...
					@SteamShipLinekey,@Consignee, @OutPut OUTPUT,@SenderInfo
			End
			...
			Begin
				...
				Select OrderDetailKey,containerid,ContainerNo,ContainerSize,
					...
					StopDetailKeySF, StopDetailKeyST, StopDetailKeyRT, StopDetailKeySTA, 
					StopDetailKeySTB, Containerprops, LocTypeSF, LocTypeST, LocTypeRT, LocTypeSTA, 
					LocTypeSTB	, ODStopKeySF, ODStopKeyST, ODStopKeyRT, ODStopKeySTA, ODStopKeySTB,
					OrderType,BookingNo, Ref, DropOrLive, PriorityKey,CSRKey	
				...
				Fetch Next from CurDetail 
					into  @OrderDetailKey_Cur,  @containerid_Cur, @ContainerNo_Cur, @ContainerSize_Cur,
							...
							@VesselETA_Cur, @IsHazardous_cur, @StopDetailKeySF, @StopDetailKeyST, 
							@StopDetailKeyRT, @StopDetailKeySTA, @StopDetailKeySTB, @Containerprops,
							@LocTypeSF, @LocTypeST, @LocTypeRT, @LocTypeSTA, @LocTypeSTB, @ODStopKeySF, 
							@ODStopKeyST, @ODStopKeyRT, @ODStopKeySTA, @ODStopKeySTB,
							@ContOrderType, @ContBookingNo, @ContRef, @DropOrLive, @PriorityKey	,@CSRKey_Cur
				...
				BEGIN  
					...
					Begin
						...
						@StopDetailKeySF	as StopDetailKeySF	,
						@StopDetailKeyST	as StopDetailKeyST,	
						@StopDetailKeyRT	as StopDetailKeyRT,	
						@StopDetailKeySTA	as StopDetailKeySTA,	
						@StopDetailKeySTB	as StopDetailKeySTB,	
