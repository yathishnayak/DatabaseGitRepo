...
CREATE Proc [dbo].[TMS_Integration_ReverseMapping_ACER_Delete] -- TMS_Integration_ReverseMapping_ACER_Delete 1128
(
	@DataKey		INT
)
as
...
Begin
	...
	SELECT '333',* FROM #TMP_ACER_Header
	...
	SELECT		IH.DataKey as TKT_DataKey, 
				...
				OH2.CustKey,
				@SiteId as SiteID, IH.isAccepted-- , OH2.CustKey, OH2.BrokerRefNo , IH.shipmentReferenceNumber
	INTO		#Temp_ACER
	...
	WHERE		IC.equipmentNumber = OD.ContainerNo
				and (OH2.OrderKey is not null OR OH.OrderKey is not null )  and IH.isAccepted =1 and ISNULL(OH2.CustKey,OH.CustKey) = @CustKey
