...
DECLARE 
	...
	@Reason VARCHAR(100)=''
EXec Scheduler_GetListV2_Shiva_20260128_2 @UserKey,@JSONString,@Status OUTPUT,@Reason OUTPUT, @IsDebug
Select @Status, @Reason
**/
CREATE PROCEDURE [dbo].[Scheduler_GetListV2_Shiva_20260128_2]   
	@UserKey		int,
...
--SET STATISTICS IO, TIME ON;
	...
	select Od.orderdetailkey, OH.orderKey, OD.Status, CONVERT(biT, 0) AS IsDataRequired
