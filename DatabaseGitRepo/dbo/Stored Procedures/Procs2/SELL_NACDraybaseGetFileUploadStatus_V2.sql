...
Declare 
	...
	EXEC [SELL_NACDraybaseGetFileUploadStatus_V2] @Userkey, @JSONSTRING, @Status OUTPUT, @Reason Output, @IsDebug
	SELECT @Status AS Status, @Reason AS Reason
**/
CREATE PROCEDURE [dbo].[SELL_NACDraybaseGetFileUploadStatus_V2]
(
	@UserKey		INT = 1144,
	@JSONString		NVARCHAR(MAX) = '',
	@Status			BIT	= 0 OUTPUT,
...
BEGIN
	...
	FROM				SELL_NAC_Draybase_FileProcessInfo F
