...
--set @JsonString = '{"ContainerNo":"","ThisWeek":false,"Today":false,"NextWeek":false,"ThisMonth":false,"DemurrageStatus":false,"DetentionStatus":false,"NearingDemurrage":false,"WithDemurrage":false,"WithDetention":false,"Terminal":"","PageNo":1,"PageSize":50,"SortField":"ContainerNo","IsAscending":true,"CSMKeys":"","CSRKeys":"","ContainerStatusKeys":"","CustKeys":"","SalesPersonKeys":"","HoldStatus":""}'

Declare @UserKey int=29,@JSONString nvarchar(max),@Status 	bit	= 0,@Reason	varchar(1000) = '' 
set @JsonString = '{"ThisWeek":false,"Today":false,"Arrived":false,"NextWeek":false,"ThisMonth":false,"DemurrageStatus":false,"DetentionStatus":false,"NearingDemurrage":false,"WithDemurrage":false,"WithDetention":false,"Terminal":"","PageNo":1,"PageSize":50,"SortField":"ContainerNo","IsAscending":true,"CSMKeys":"","CSRKeys":"","ContainerStatusKeys":"","CustKeys":"","SalesPersonKeys":"","HoldStatus":"","TerminalNames":"","MarketKeys":"","SearchText":"HPCU2630107","DischargeYN":"","IsScheduledYN":"","PickupAvailable":"","HoldTypes":"","PickUpFrom":null,"PickUpTo":null}'
exec Gnosis_Integration_GetContainerDetails_Delete @UserKey, @JSONString, @Status output, @Reason output
select @Status, @Reason
*/
CREATE PROCEDURE	[dbo].[Gnosis_Integration_GetContainerDetails_Delete] -- Gnosis_Integration_GetContainerDetails 'GAOU6974889'
(
	@UserKey		int,
...
BEGIN
	...
	Select @ContainerNo = ContainerNo, @IsThisWeek = isnull(ThisWeek,0), 
		...
		@MarketKeys = isnull(MarketKeys,''), @DischargeYN = isnull(DischargeYN,'N'),@IsScheduledYN = IsScheduledYN,
	...
	Begin
		...
		@IsCTF  as  IsCTF, @IsTMF  as  IsTMF, @IsLine  as  IsLine, @IsOther  as  IsOther, @IsCustoms  as  IsCustoms, @IsFreight AS IsFreight,
		@IsClosedArea AS ClosedArea,
...
--					,'' Custom_detention_demurrage_calc
					...
					,MBL_number
					,Dropped
					, CTF,TMF,Line,Other,Customs,Freight,ClosedArea	
					...
					, CASE WHEN ISNULL(CD.Pickup_appointment_dt,'') = '' then 'N' else 'Y' end as IsScheduledYN
	...
	Begin
		SELECT 'A'
		Select *  from #DataTemp WHERE Container_number = 'HPCU2630107'
	End
	print 'Done 2'
	...
	SELECT 1
	SELECT * FROM #Data WHERE ContainerNo = 'HPCU2630107'
	...
	WHERE			
		...
		(Isnull(@HoldStatus,'') = '' OR (@HoldStatus ='YES' and ( CTF = 'true' OR TMF = 'true' 
			OR Line = 'true' OR Other = 'true' OR Customs = 'true' OR Freight = 'true' OR ClosedArea = 'true')) OR 
			(@HoldStatus ='NO' and (CTF = 'false' and TMF = 'false' 
			and Line = 'false' and Other = 'false' and Customs = 'false' and Freight = 'false' and ClosedArea = 'false'))) AND
		...
		(ISNULL(@IsScheduledYN,'') = '' OR IsScheduledYN = @IsScheduledYN) AND
