...
/* --19907, 25335 -- Acc Rate : SMB- 47507, ENT- 47502
	DECLARE @InvoiceKey int =0, @InvoiceNo Varchar(50) = '130870',   @JsonOutput nvarchar(max) ='',@Status	bit = 0 , @Reason	varchar(500) = '' ,
	...
	DECLARE @InvoiceKey int =0, @InvoiceNo Varchar(50) = '122101',   @JsonOutput nvarchar(max) ='',@Status	bit = 0 , @Reason	varchar(500) = '' ,
		@IsSpotOn bit = 0, @CustomerSegment varchar(5) = 'NAC', @Debug bit = 1
	EXEC [Sell_OutputByInvoice] @InvoiceKey, @InvoiceNo, @IsSpotOn, @CustomerSegment, @JsonOutput OUTPUT, @Status OUTPUT, @Reason OUTPUT, @Debug
	SELECT @JsonOutput, @Status, @Reason
*/
CREATE PRoc [dbo].[Sell_OutputByInvoice_BASE22042025]
(
	@InvoiceKey			int	= 0,
...
BEGIN
	...
	BEGIN
		...
		set @IsSteam = case when @Custkey = 2692 then 1 else 0 end
