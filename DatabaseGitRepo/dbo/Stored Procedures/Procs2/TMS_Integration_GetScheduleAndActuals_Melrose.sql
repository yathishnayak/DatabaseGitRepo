...
CREATE Proc [dbo].[TMS_Integration_GetScheduleAndActuals_Melrose] -- TMS_Integration_GetScheduleAndActuals_Melrose 72606, 8
(
	@TMS_OrderKey	int,
	@DataKey		int
)
...
BEGIN
	...
	Begin
		...
		from (
			...
			inner join Integration_JCB.dbo.Melrose_StopList SL on TR.StopKey = SL.StopKey AND TR.Stoptype = SL.FacilityCode
