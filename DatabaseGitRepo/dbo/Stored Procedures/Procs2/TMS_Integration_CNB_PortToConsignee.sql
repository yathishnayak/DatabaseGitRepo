...
CREATE proc [dbo].[TMS_Integration_CNB_PortToConsignee] -- TMS_Integration_CNB_PortToConsignee 16084
(
	 @DataKey	int = 16084
)
as
BEGIN
	...
	where SiteID = 'CNB' and TH.DataKey =  @DataKey
	...
	inner join Integration_JCB.dbo.CNB_StopList SL on TRC.ContainerKey = SL.ContainerKey -- and TRT.StopKey = SL.StopKey
	...
	inner join Integration_JCB.dbo.CNB_StopList SL on TRT.ContainerKey = SL.ContainerKey  and TRT.StopKey = SL.StopKey
