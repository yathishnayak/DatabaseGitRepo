...
*/
CREATE procEDURE [dbo].[TMS_integration_InsertOrder_Robinson]
(
	@SiteId				varchar(50),
	@DataKey			int,
	@Json				nvarchar(max),
...
BEGIN
	...
	Begin Try
		...
		insert into #Header ( DataKey, FileProcessKey, TMS_OrderKey, TMS_CustKey, TMS_SourceAddrKey, TMS_DestinationAddrKey, 
			...
			ErrorLine,L11Lines, notes, Consignee, Sender, TMS_MarketLocationKey )
		...
		Begin
			...
			INSERT INTO dbo.OrderHeader(OrderNo, OrderDate,Csrkey, CustKey,   
						...
						BillToAddrKey,ETADate,BaseRateAmount, SenderInfo, MarketLocationKey, OrderSource )
			Select
						...
						,@BillToAddrKey,ETADate,@BaseRateAmount, Sender , TMS_MarketLocationKey,'Robinson'
			From #Header
