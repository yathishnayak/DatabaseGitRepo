...
declare @SiteId				varchar(50) = 'FLEXPORT',
		@DataKey			int = 20521,
		@Json				nvarchar(max) = '{"DataKey":20521,"FileProcessKey":25219,"originatorCode":"FLEXPORT       ","receiverCode":"IPGL           ","workOrderNumber":"000063705","category":"Import Shipment","createdBy":null,"workOrderDate":"2024-02-10T15:01:00","houseAirWayBillNumber":"","shipmentReferenceNumber":"FLEX-2535269B-5923276","billOfLadingNumber":"COSU6231606130","vessel":"ONE HAMMERSMITH","voyage":"080E","portOfLoading":"JPTYO","portOfDischarge":"USLAX","eta":"2024-01-31T12:00:00","shipper":"FLEXPORT       ","broker":null,"carrierCode":"COSCO Container L.","isAccepted":true,"RejectReasonCode":"","RejectMessage":"","IsProcessed":false,"SiteID":"flexport","ResponseType":"Reject","IsResponseSent":false,"ResponseSentDate":"0001-01-01T00:00:00","FileName":"204_IPGL_eff142aec662576d722c90071e57abf7_20240210150142-2024-02-10T15-01-43Z.edi","TMS_OrderKey":0,"TMS_OrderNo":"Pending","TMS_OrderDate":"0001-01-01T00:00:00","ContainerList":[{"ContainerKey":20521,"equipmentNumber":"OOCU9011429","equipmentTypeCode":"45G0","pieceCount":0,"grossWeight":5780,"weightUOM":"Kilograms","volume":0,"volumeUOM":null,"freightDescription":null,"sealNumberList":"","StopList":[{"StopKey":39484,"stopType":"Ship From","stopName":"YUSEN TERMINAL INC (LA) BERTH 214","stopNumber":1,"facilityCode":"SF","stopReferenceNumber":1,"address1":"701 NEW DOCK STREET FIRMS- Y790","city":"TERMINAL ISLAND","state":"CA","country":"US","postalCode":"90731","ScheduledDateTime":"0001-01-01T00:00:00","IsScheduleSent":false,"ActualDateTime":"0001-01-01T00:00:00","IsActualSent":false,"TMS_RouteKey":0,"TMS_SourceAddrKey":28543,"TMS_DestinationAddrKey":0,"TMS_LegKey":2,"ScheduledDate":"2024-02-10T20:00:00","_selectedLeg":{"LegKey":2,"LegID":"Port To Consignee","FromLocation":"Port","ToLocation":"Customer","PickUpType":"Port"},"LegSelectedItems":[{"LegKey":2,"LegID":"Port To Consignee","FromLocation":"Port","ToLocation":"Customer","PickUpType":"Port"}],"_LocationList":[],"SourSelectedItems":[{"Name":"YUSEN","AddrKey":28543,"AddrName":"YUSEN","Address1":"701 NEW DOCK ST","Address2":"","City":"Terminal Island","State":"CA","ZipCode":"90731","Country":"USA","Type":"PORT","NameFull":"YUSEN, 701 NEW DOCK ST, Terminal Island, 90731"}]},{"StopKey":39485,"stopType":"Ship To","stopName":"Tatcha LLC","stopNumber":2,"facilityCode":"ST","stopReferenceNumber":2,"address1":"2041 Mariposa Ave  FIRMS-","city":"El Segundo","state":"CA","country":"US","postalCode":"90245","ScheduledDateTime":"0001-01-01T00:00:00","IsScheduleSent":false,"ActualDateTime":"0001-01-01T00:00:00","IsActualSent":false,"TMS_RouteKey":0,"TMS_SourceAddrKey":0,"TMS_DestinationAddrKey":26878,"TMS_LegKey":2,"ScheduledDate":"2024-02-12T20:00:00","_selectedLeg":{"LegKey":2,"LegID":"Port To Consignee","FromLocation":"Port","ToLocation":"Customer","PickUpType":"Port"},"LegSelectedItems":[{"LegKey":2,"LegID":"Port To Consignee","FromLocation":"Port","ToLocation":"Customer","PickUpType":"Port"}],"_LocationList":[],"DestSelectedItems":[{"Name":"TATCHA","AddrKey":26878,"AddrName":"TATCHA","Address1":"2041 MARIPOSA AVE ","Address2":"","City":"El Segundo","State":"CA","ZipCode":"90245","Country":"   ","Type":"Customer","NameFull":"TATCHA, 2041 MARIPOSA AVE , El Segundo, 90245"}]}],"TMS_ContainerSizeKey":12,"TMSOrderDetailKey":0,"IsHazmat":false,"HazardInfo":null,"ContSelectedItems":[{"ContainerSizeKey":12,"Description":"40 HC"}]}],"TMS_CustKey":1966,"TMS_SourceAddrKey":28543,"TMS_DestinationAddrKey":26878,"TMS_OrderTypeKey":1,"TMS_BorkerKey":5,"TMS_CarrierKey":6,"TMS_CSRKey":41,"UserKey":"29","IsConfirmed":true,"ConfirmDate":"2024-02-12T08:04:55.757","ErrorLines":null,"L11Lines":[{"Description":"eff142aec662576d722c90071e57abf7","EDIDescription":"MutuallyDefined","RefData":"ZZ","RefEDIID":"ZZ"},{"Description":null,"EDIDescription":"OfferGroup","RefData":"Delivery Order","RefEDIID":"OK"},{"Description":null,"EDIDescription":"PurchaseOrderNumber","RefData":"CC02130T","RefEDIID":"PO"},{"Description":null,"EDIDescription":"SubhouseBillofLading","RefData":"COSU623160613001","RefEDIID":"4Y"}],"notes":[{"NoteLine":"FLEX-2535269B"},{"NoteLine":"null"}],"ScheduleFiles":null,"ActualFiles":null,"InvoiceFiles":null,"ProcessStatus":null,"ProcStatusDate":"0001-01-01T00:00:00","ProcStatusDataKey":0,"ProcworkOrderNumber":null,"ProcFileProcessKey":0,"IsArchived":false,"ArchiveDate":"0001-01-01T00:00:00","IsDuplicate":false,"IsUpdate":false,"IsCancel":false,"Consignee":"Tatcha"}',
		@UserKey			int = 29,
		@IsSaved			bit = 0 ,
		@Reason				varchar(500)='' ,
		@OrderKey			INT =0 ,
...
*/
CREATE PROCEDURE [dbo].[TMS_integration_InsertOrder_Flexport]
(
	@SiteId				varchar(50),
	@DataKey			int,
	@Json				nvarchar(max),
...
BEGIN
	...
	Begin Try
		...
		Begin
			...
			SET @OrderType = (SELECT OrderType FROM Integration_JCB.dbo.Flexpro_Header A
			...
			Select
						...
						,@BillToAddrKey,ETADate,@BaseRateAmount , TMS_MarketLocationKey, 'Flexport'
			From #Header

			SET @NewOrderKeyOut =( SELECT SCOPE_IDENTITY() )

			EXEC TMS_Integration_UpdateConsignee_Flexport
			...
			---------------------Booking No Update--------------------------------------
			----SELECT		*
			--UPDATE		OH SET BookingNo = H.BookingNo
			--FROM		OrderHeader OH
			--INNER JOIN	Integration_JCB.dbo.Flexpro_Header H ON OH.OrderKey = H.TMS_OrderKey
		...
		BEGIN
			...
			-- SELECt [Status],BrokerRefNo INTO #OrderHeader FROM OrderHeader WITH (NOLOCK) WHERE OrderKey= @Orderkey

			SET @OrderDetailStatus= (SELECT CASE WHEN [Status]=8 THEN 11 ELSE 1 END  FROM OrderHeader WITH (NOLOCK) WHERE OrderKey= @Orderkey)
			SET @BroRefNo= (SELECT BrokerRefNo FROM OrderHeader WITH (NOLOCK) WHERE OrderKey= @Orderkey)
			...
			Begin
				...
				SET		@ContainerNo = 'JCTD' + Right(convert(varchar(5), year(getdate())),2) 
						+ right(convert(varchar(5),100 + MONTH(Getdate())),2) + 
			...
			INSERT INTO dbo.OrderDetail(OrderKey,ContainerID,ContainerNo,ContainerSizeKey,
				...
				DestinationAddrKey,CreateDate, VesselETA,CustRefNo) 
			SELECT  @Orderkey , @ContainerId,isnull(@Containerno,@OrderNo) , @TMS_ContainerSizeKey ,
				...
				@DestAddrKey,GETDATE(), @ETADate, @BroRefNo
